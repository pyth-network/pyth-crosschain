...
const UPGRADE_GUARDIAN_SET_VAA_7 : &str = "";
...
fn initialize_wormhole_receiver(
    ...
    if current_guardian_set_index == 6 {
        ...
        process_upgrade_guardian_set(
            rpc_client,
            &hex::decode(UPGRADE_GUARDIAN_SET_VAA_7)
...
mod tests {
    use {
        super::*,
        wormhole_core_bridge_solana::legacy::state::LEGACY_GUARDIANS,
        wormhole_sdk::core::{Action, GovernancePacket},
    };

    /// Wormhole testnet guardian (testnet guardian set 0). It never appears in the mainnet
    /// upgrade VAAs but is part of `LEGACY_GUARDIANS` to cover testnet deployments.
    const TESTNET_GUARDIAN: &str = "13947bd48b18e53fdaeee77f3473391ac727c638";

    fn decode_guardian(hex_str: &str) -> [u8; 20] {
        hex::decode(hex_str).unwrap().try_into().unwrap()
    }

    fn upgrade_vaa_guardians(vaa_hex: &str) -> (u32, Vec<[u8; 20]>) {
        let vaa: Vaa<GovernancePacket> =
            serde_wormhole::from_slice(&hex::decode(vaa_hex).unwrap()).unwrap();
        match vaa.payload.action {
            ...
            action => panic!("VAA is not a guardian set upgrade: {action:?}"),
        }
    }

    #[test]
    fn test_legacy_guardians_match_upgrade_vaas() {
        // `LEGACY_GUARDIANS` is expected to contain, in order of first appearance, every
        // guardian that has ever been part of a mainnet guardian set (the initial set plus
        // all upgrade VAAs), followed by the testnet guardian.
        let mut expected: Vec<[u8; 20]> = vec![decode_guardian(INITIAL_GUARDIAN)];
        for (i, vaa) in [
            ...
            UPGRADE_GUARDIAN_SET_VAA_6,
            UPGRADE_GUARDIAN_SET_VAA_7,
        ]
        .iter()
        .enumerate()
        {
            let (new_guardian_set_index, guardians) = upgrade_vaa_guardians(vaa);
            assert_eq!(new_guardian_set_index, i as u32 + 1);
            for guardian in guardians {
                if !expected.contains(&guardian) {
                    expected.push(guardian);
                }
            }
        }
        expected.push(decode_guardian(TESTNET_GUARDIAN));

        assert_eq!(LEGACY_GUARDIANS.to_vec(), expected);
    }
}
