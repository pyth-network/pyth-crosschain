/** biome-ignore-all lint/style/noProcessEnv: this is an example file, so using process.env is okay for demonstration */
...
async function main() {
  ...
  const _tx = await contract.functions
