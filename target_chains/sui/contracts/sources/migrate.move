...
public struct MigrateComplete has copy, drop {
    package: ID,
}

public fun migrate(pyth_state: &mut State, receipt: WormholeVAAVerificationReceipt) {
...
fun handle_migrate(pyth_state: &mut State, receipt: WormholeVAAVerificationReceipt) {
