...
public use fun get_is_negative as I64.is_negative;

public fun get_is_negative(i: &I64): bool {
    i.negative
}

public use fun get_magnitude_if_positive as I64.magnitude_if_positive;
...
public use fun get_magnitude_if_negative as I64.magnitude_if_negative;
