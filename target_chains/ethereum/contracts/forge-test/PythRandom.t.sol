...
contract PythRandomTest is Test, RandTestUtils {
    ...
    function testBasic() public {
        ...
        uint64 sequenceNumber = random.request{
            value: pythFeeInWei + providerOneFeeInWei
        }(providerOne, commitment, false);

        assertRevealSucceeds(
            providerOne,
            sequenceNumber,
            userRandom,
            providerOneProofs[sequenceNumber]
        );
    ...
    function testRotate() public {
        ...
        vm.prank(user);
        uint64 sequenceNumber1 = random.request{
            value: pythFeeInWei + providerOneFeeInWei
        }(providerOne, commitment, false);

        vm.prank(user);
        uint64 sequenceNumber2 = random.request{
            value: pythFeeInWei + providerOneFeeInWei
        }(providerOne, commitment, false);
        ...
        vm.prank(user);
        uint64 sequenceNumber3 = random.request{
            value: pythFeeInWei + providerOneFeeInWei
        }(providerOne, commitment, false);
        ...
        assertRevealSucceeds(
            ...
            sequenceNumber1,
            userRandom,
            providerOneProofs[sequenceNumber1]
        );
        ...
        assertRevealReverts(
            ...
            sequenceNumber3,
            userRandom,
            providerOneProofs[sequenceNumber3]
        );
        assertRevealSucceeds(
            providerOne,
            sequenceNumber3,
