...
export const pyth_lazer_transaction = $root.pyth_lazer_transaction = (() => {
    ...
    pyth_lazer_transaction.GovernanceInstruction = (function() {
         ...
         * @instance
         */
        Object.defineProperty(GovernanceInstruction.prototype, "_minExecutionTimestamp", {
         ...
         * @instance
         */
        Object.defineProperty(GovernanceInstruction.prototype, "_maxExecutionTimestamp", {
         ...
         * @instance
         */
        Object.defineProperty(GovernanceInstruction.prototype, "_governanceSequenceNo", {
        ...
        GovernanceInstruction.encode = function encode(message, writer) {
            ...
            if (message.minExecutionTimestamp != null && Object.hasOwnProperty.call(message, "minExecutionTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.minExecutionTimestamp, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.maxExecutionTimestamp != null && Object.hasOwnProperty.call(message, "maxExecutionTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.maxExecutionTimestamp, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            if (message.governanceSequenceNo != null && Object.hasOwnProperty.call(message, "governanceSequenceNo"))
                writer.uint32(/* id 5, wireType 0 =*/40).uint32(message.governanceSequenceNo);
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GovernanceInstruction.encodeDelimited = function encodeDelimited(message, writer) {
        ...
        GovernanceInstruction.decode = function decode(reader, length, error) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceInstruction();
            while (reader.pos < end) {
                ...
                case 2: {
                        if (!(message.directives && message.directives.length))
                            message.directives = [];
                        message.directives.push($root.pyth_lazer_transaction.GovernanceDirective.decode(reader, reader.uint32()));
                        break;
                    }
                case 3: {
                        message.minExecutionTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        message.maxExecutionTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 5: {
        ...
        GovernanceInstruction.verify = function verify(message) {
            ...
            if (message.directives != null && message.hasOwnProperty("directives")) {
                ...
                for (let i = 0; i < message.directives.length; ++i) {
                    let error = $root.pyth_lazer_transaction.GovernanceDirective.verify(message.directives[i]);
                    if (error)
                        return "directives." + error;
                }
            }
            if (message.minExecutionTimestamp != null && message.hasOwnProperty("minExecutionTimestamp")) {
                properties._minExecutionTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.minExecutionTimestamp);
                    if (error)
                        return "minExecutionTimestamp." + error;
                }
            }
            if (message.maxExecutionTimestamp != null && message.hasOwnProperty("maxExecutionTimestamp")) {
                properties._maxExecutionTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.maxExecutionTimestamp);
                    if (error)
                        return "maxExecutionTimestamp." + error;
                }
            }
            if (message.governanceSequenceNo != null && message.hasOwnProperty("governanceSequenceNo")) {
        ...
        GovernanceInstruction.fromObject = function fromObject(object) {
            ...
            if (object.directives) {
                ...
                message.directives = [];
                for (let i = 0; i < object.directives.length; ++i) {
                    if (typeof object.directives[i] !== "object")
                        throw TypeError(".pyth_lazer_transaction.GovernanceInstruction.directives: object expected");
                    message.directives[i] = $root.pyth_lazer_transaction.GovernanceDirective.fromObject(object.directives[i]);
                }
            }
            if (object.minExecutionTimestamp != null) {
                if (typeof object.minExecutionTimestamp !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceInstruction.minExecutionTimestamp: object expected");
                message.minExecutionTimestamp = $root.google.protobuf.Timestamp.fromObject(object.minExecutionTimestamp);
            }
            if (object.maxExecutionTimestamp != null) {
                if (typeof object.maxExecutionTimestamp !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceInstruction.maxExecutionTimestamp: object expected");
                message.maxExecutionTimestamp = $root.google.protobuf.Timestamp.fromObject(object.maxExecutionTimestamp);
            }
        ...
        GovernanceInstruction.toObject = function toObject(message, options) {
            ...
            if (message.directives && message.directives.length) {
                ...
                for (let j = 0; j < message.directives.length; ++j)
                    object.directives[j] = $root.pyth_lazer_transaction.GovernanceDirective.toObject(message.directives[j], options);
            }
            if (message.minExecutionTimestamp != null && message.hasOwnProperty("minExecutionTimestamp")) {
                object.minExecutionTimestamp = $root.google.protobuf.Timestamp.toObject(message.minExecutionTimestamp, options);
                if (options.oneofs)
                    object._minExecutionTimestamp = "minExecutionTimestamp";
            }
            if (message.maxExecutionTimestamp != null && message.hasOwnProperty("maxExecutionTimestamp")) {
                object.maxExecutionTimestamp = $root.google.protobuf.Timestamp.toObject(message.maxExecutionTimestamp, options);
                if (options.oneofs)
    ...
    pyth_lazer_transaction.ShardFilter = (function() {
        ...
        Object.defineProperty(ShardFilter.prototype, "filter", {
            get: $util.oneOfGetter($oneOfFields = ["allShards", "shardNames", "shardGroups"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        ShardFilter.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.allShards != null && Object.hasOwnProperty.call(message, "allShards"))
                $root.google.protobuf.Empty.encode(message.allShards, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.shardNames != null && Object.hasOwnProperty.call(message, "shardNames"))
                $root.pyth_lazer_transaction.ShardFilter.ShardNames.encode(message.shardNames, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.shardGroups != null && Object.hasOwnProperty.call(message, "shardGroups"))
                $root.pyth_lazer_transaction.ShardFilter.ShardGroups.encode(message.shardGroups, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
        ...
        ShardFilter.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.allShards = $root.google.protobuf.Empty.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.shardNames = $root.pyth_lazer_transaction.ShardFilter.ShardNames.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.shardGroups = $root.pyth_lazer_transaction.ShardFilter.ShardGroups.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ShardFilter.verify = function verify(message) {
            ...
            if (message.allShards != null && message.hasOwnProperty("allShards")) {
                properties.filter = 1;
                {
                    let error = $root.google.protobuf.Empty.verify(message.allShards);
                    if (error)
                        return "allShards." + error;
                }
            }
            if (message.shardNames != null && message.hasOwnProperty("shardNames")) {
                ...
                properties.filter = 1;
                {
                    let error = $root.pyth_lazer_transaction.ShardFilter.ShardNames.verify(message.shardNames);
                    if (error)
                        return "shardNames." + error;
                }
            }
            if (message.shardGroups != null && message.hasOwnProperty("shardGroups")) {
                if (properties.filter === 1)
                    return "filter: multiple values";
                properties.filter = 1;
                {
                    let error = $root.pyth_lazer_transaction.ShardFilter.ShardGroups.verify(message.shardGroups);
                    if (error)
                        return "shardGroups." + error;
                }
            }
            return null;
        };
        ...
        ShardFilter.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.ShardFilter)
                return object;
            let message = new $root.pyth_lazer_transaction.ShardFilter();
            if (object.allShards != null) {
                if (typeof object.allShards !== "object")
                    throw TypeError(".pyth_lazer_transaction.ShardFilter.allShards: object expected");
                message.allShards = $root.google.protobuf.Empty.fromObject(object.allShards);
            }
            if (object.shardNames != null) {
                if (typeof object.shardNames !== "object")
                    throw TypeError(".pyth_lazer_transaction.ShardFilter.shardNames: object expected");
                message.shardNames = $root.pyth_lazer_transaction.ShardFilter.ShardNames.fromObject(object.shardNames);
            }
            if (object.shardGroups != null) {
                if (typeof object.shardGroups !== "object")
                    throw TypeError(".pyth_lazer_transaction.ShardFilter.shardGroups: object expected");
                message.shardGroups = $root.pyth_lazer_transaction.ShardFilter.ShardGroups.fromObject(object.shardGroups);
            }
            return message;
        };
        ...
        ShardFilter.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.allShards != null && message.hasOwnProperty("allShards")) {
                object.allShards = $root.google.protobuf.Empty.toObject(message.allShards, options);
                if (options.oneofs)
                    object.filter = "allShards";
            }
            if (message.shardNames != null && message.hasOwnProperty("shardNames")) {
                object.shardNames = $root.pyth_lazer_transaction.ShardFilter.ShardNames.toObject(message.shardNames, options);
                if (options.oneofs)
                    object.filter = "shardNames";
            }
            if (message.shardGroups != null && message.hasOwnProperty("shardGroups")) {
                object.shardGroups = $root.pyth_lazer_transaction.ShardFilter.ShardGroups.toObject(message.shardGroups, options);
                if (options.oneofs)
                    object.filter = "shardGroups";
            }
            return object;
        };
        ...
        ShardFilter.ShardNames = (function() {
            ...
            ShardNames.encode = function encode(message, writer) {
                ...
                if (message.shardNames != null && message.shardNames.length)
                    for (let i = 0; i < message.shardNames.length; ++i)
                        writer.uint32(/* id 1, wireType 2 =*/10).string(message.shardNames[i]);
                return writer;
            };
            ...
            ShardNames.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter.ShardNames();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ShardNames.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.ShardFilter.ShardNames)
                    return object;
                let message = new $root.pyth_lazer_transaction.ShardFilter.ShardNames();
                if (object.shardNames) {
                    if (!Array.isArray(object.shardNames))
                        throw TypeError(".pyth_lazer_transaction.ShardFilter.ShardNames.shardNames: array expected");
                    message.shardNames = [];
                    for (let i = 0; i < object.shardNames.length; ++i)
            ...
            ShardNames.toObject = function toObject(message, options) {
                ...
                if (message.shardNames && message.shardNames.length) {
                    object.shardNames = [];
                    for (let j = 0; j < message.shardNames.length; ++j)
        ...
        ShardFilter.ShardGroups = (function() {
            ...
            ShardGroups.encode = function encode(message, writer) {
                ...
                if (message.shardGroups != null && message.shardGroups.length)
                    for (let i = 0; i < message.shardGroups.length; ++i)
                        writer.uint32(/* id 1, wireType 2 =*/10).string(message.shardGroups[i]);
                return writer;
            };
            ...
            ShardGroups.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter.ShardGroups();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ShardGroups.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.ShardFilter.ShardGroups)
                    return object;
                let message = new $root.pyth_lazer_transaction.ShardFilter.ShardGroups();
                if (object.shardGroups) {
                    if (!Array.isArray(object.shardGroups))
                        throw TypeError(".pyth_lazer_transaction.ShardFilter.ShardGroups.shardGroups: array expected");
                    message.shardGroups = [];
                    for (let i = 0; i < object.shardGroups.length; ++i)
            ...
            ShardGroups.toObject = function toObject(message, options) {
                ...
                if (message.shardGroups && message.shardGroups.length) {
                    object.shardGroups = [];
                    for (let j = 0; j < message.shardGroups.length; ++j)
            ...
            ShardGroups.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/pyth_lazer_transaction.ShardFilter.ShardGroups";
            };
    ...
    pyth_lazer_transaction.GovernanceDirective = (function() {
        ...
        Object.defineProperty(GovernanceDirective.prototype, "action", {
            get: $util.oneOfGetter($oneOfFields = ["createShard", "addGovernanceSource", "updateGovernanceSource", "setShardName", "setShardGroup", "resetLastSequenceNo", "addPublisher", "updatePublisher", "addFeed", "updateFeed"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        GovernanceDirective.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.shardFilter != null && Object.hasOwnProperty.call(message, "shardFilter"))
                $root.pyth_lazer_transaction.ShardFilter.encode(message.shardFilter, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.createShard != null && Object.hasOwnProperty.call(message, "createShard"))
                $root.pyth_lazer_transaction.CreateShard.encode(message.createShard, writer.uint32(/* id 101, wireType 2 =*/810).fork()).ldelim();
            if (message.addGovernanceSource != null && Object.hasOwnProperty.call(message, "addGovernanceSource"))
                $root.pyth_lazer_transaction.AddGovernanceSource.encode(message.addGovernanceSource, writer.uint32(/* id 102, wireType 2 =*/818).fork()).ldelim();
            if (message.updateGovernanceSource != null && Object.hasOwnProperty.call(message, "updateGovernanceSource"))
                $root.pyth_lazer_transaction.UpdateGovernanceSource.encode(message.updateGovernanceSource, writer.uint32(/* id 103, wireType 2 =*/826).fork()).ldelim();
            if (message.setShardName != null && Object.hasOwnProperty.call(message, "setShardName"))
                $root.pyth_lazer_transaction.SetShardName.encode(message.setShardName, writer.uint32(/* id 104, wireType 2 =*/834).fork()).ldelim();
            if (message.setShardGroup != null && Object.hasOwnProperty.call(message, "setShardGroup"))
                $root.pyth_lazer_transaction.SetShardGroup.encode(message.setShardGroup, writer.uint32(/* id 105, wireType 2 =*/842).fork()).ldelim();
            if (message.resetLastSequenceNo != null && Object.hasOwnProperty.call(message, "resetLastSequenceNo"))
                $root.pyth_lazer_transaction.ResetLastSequenceNo.encode(message.resetLastSequenceNo, writer.uint32(/* id 106, wireType 2 =*/850).fork()).ldelim();
            if (message.addPublisher != null && Object.hasOwnProperty.call(message, "addPublisher"))
                $root.pyth_lazer_transaction.AddPublisher.encode(message.addPublisher, writer.uint32(/* id 107, wireType 2 =*/858).fork()).ldelim();
            if (message.updatePublisher != null && Object.hasOwnProperty.call(message, "updatePublisher"))
                $root.pyth_lazer_transaction.UpdatePublisher.encode(message.updatePublisher, writer.uint32(/* id 108, wireType 2 =*/866).fork()).ldelim();
            if (message.addFeed != null && Object.hasOwnProperty.call(message, "addFeed"))
                $root.pyth_lazer_transaction.AddFeed.encode(message.addFeed, writer.uint32(/* id 109, wireType 2 =*/874).fork()).ldelim();
            if (message.updateFeed != null && Object.hasOwnProperty.call(message, "updateFeed"))
                $root.pyth_lazer_transaction.UpdateFeed.encode(message.updateFeed, writer.uint32(/* id 110, wireType 2 =*/882).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GovernanceDirective.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        GovernanceDirective.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceDirective();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.shardFilter = $root.pyth_lazer_transaction.ShardFilter.decode(reader, reader.uint32());
                        break;
                    }
                case 101: {
                        message.createShard = $root.pyth_lazer_transaction.CreateShard.decode(reader, reader.uint32());
                        break;
                    }
                case 102: {
                        message.addGovernanceSource = $root.pyth_lazer_transaction.AddGovernanceSource.decode(reader, reader.uint32());
                        break;
                    }
                case 103: {
                        message.updateGovernanceSource = $root.pyth_lazer_transaction.UpdateGovernanceSource.decode(reader, reader.uint32());
                        break;
                    }
                case 104: {
                        message.setShardName = $root.pyth_lazer_transaction.SetShardName.decode(reader, reader.uint32());
                        break;
                    }
                case 105: {
                        message.setShardGroup = $root.pyth_lazer_transaction.SetShardGroup.decode(reader, reader.uint32());
                        break;
                    }
                case 106: {
                        message.resetLastSequenceNo = $root.pyth_lazer_transaction.ResetLastSequenceNo.decode(reader, reader.uint32());
                        break;
                    }
                case 107: {
                        message.addPublisher = $root.pyth_lazer_transaction.AddPublisher.decode(reader, reader.uint32());
                        break;
                    }
                case 108: {
                        message.updatePublisher = $root.pyth_lazer_transaction.UpdatePublisher.decode(reader, reader.uint32());
                        break;
                    }
                case 109: {
                        message.addFeed = $root.pyth_lazer_transaction.AddFeed.decode(reader, reader.uint32());
                        break;
                    }
                case 110: {
                        message.updateFeed = $root.pyth_lazer_transaction.UpdateFeed.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        GovernanceDirective.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.shardFilter != null && message.hasOwnProperty("shardFilter")) {
                properties._shardFilter = 1;
                {
                    let error = $root.pyth_lazer_transaction.ShardFilter.verify(message.shardFilter);
                    if (error)
                        return "shardFilter." + error;
                }
            }
            if (message.createShard != null && message.hasOwnProperty("createShard")) {
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.CreateShard.verify(message.createShard);
                    if (error)
                        return "createShard." + error;
                }
            }
            if (message.addGovernanceSource != null && message.hasOwnProperty("addGovernanceSource")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.AddGovernanceSource.verify(message.addGovernanceSource);
                    if (error)
                        return "addGovernanceSource." + error;
                }
            }
            if (message.updateGovernanceSource != null && message.hasOwnProperty("updateGovernanceSource")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.UpdateGovernanceSource.verify(message.updateGovernanceSource);
                    if (error)
                        return "updateGovernanceSource." + error;
                }
            }
            if (message.setShardName != null && message.hasOwnProperty("setShardName")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetShardName.verify(message.setShardName);
                    if (error)
                        return "setShardName." + error;
                }
            }
            if (message.setShardGroup != null && message.hasOwnProperty("setShardGroup")) {
                ...
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetShardGroup.verify(message.setShardGroup);
                    if (error)
                        return "setShardGroup." + error;
                }
            }
            if (message.resetLastSequenceNo != null && message.hasOwnProperty("resetLastSequenceNo")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.ResetLastSequenceNo.verify(message.resetLastSequenceNo);
                    if (error)
                        return "resetLastSequenceNo." + error;
                }
            }
            if (message.addPublisher != null && message.hasOwnProperty("addPublisher")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.AddPublisher.verify(message.addPublisher);
                    if (error)
                        return "addPublisher." + error;
                }
            }
            if (message.updatePublisher != null && message.hasOwnProperty("updatePublisher")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.UpdatePublisher.verify(message.updatePublisher);
                    if (error)
                        return "updatePublisher." + error;
                }
            }
            if (message.addFeed != null && message.hasOwnProperty("addFeed")) {
                ...
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.AddFeed.verify(message.addFeed);
                    if (error)
                        return "addFeed." + error;
                }
            }
            if (message.updateFeed != null && message.hasOwnProperty("updateFeed")) {
                ...
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.UpdateFeed.verify(message.updateFeed);
                    if (error)
                        return "updateFeed." + error;
                }
            }
            return null;
        };
        ...
        GovernanceDirective.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.GovernanceDirective)
                return object;
            let message = new $root.pyth_lazer_transaction.GovernanceDirective();
            if (object.shardFilter != null) {
                if (typeof object.shardFilter !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.shardFilter: object expected");
                message.shardFilter = $root.pyth_lazer_transaction.ShardFilter.fromObject(object.shardFilter);
            }
            if (object.createShard != null) {
                if (typeof object.createShard !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.createShard: object expected");
                message.createShard = $root.pyth_lazer_transaction.CreateShard.fromObject(object.createShard);
            }
            if (object.addGovernanceSource != null) {
                if (typeof object.addGovernanceSource !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.addGovernanceSource: object expected");
                message.addGovernanceSource = $root.pyth_lazer_transaction.AddGovernanceSource.fromObject(object.addGovernanceSource);
            }
            if (object.updateGovernanceSource != null) {
                if (typeof object.updateGovernanceSource !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.updateGovernanceSource: object expected");
                message.updateGovernanceSource = $root.pyth_lazer_transaction.UpdateGovernanceSource.fromObject(object.updateGovernanceSource);
            }
            if (object.setShardName != null) {
                if (typeof object.setShardName !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.setShardName: object expected");
                message.setShardName = $root.pyth_lazer_transaction.SetShardName.fromObject(object.setShardName);
            }
            if (object.setShardGroup != null) {
                if (typeof object.setShardGroup !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.setShardGroup: object expected");
                message.setShardGroup = $root.pyth_lazer_transaction.SetShardGroup.fromObject(object.setShardGroup);
            }
            if (object.resetLastSequenceNo != null) {
                if (typeof object.resetLastSequenceNo !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.resetLastSequenceNo: object expected");
                message.resetLastSequenceNo = $root.pyth_lazer_transaction.ResetLastSequenceNo.fromObject(object.resetLastSequenceNo);
            }
            if (object.addPublisher != null) {
                if (typeof object.addPublisher !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.addPublisher: object expected");
                message.addPublisher = $root.pyth_lazer_transaction.AddPublisher.fromObject(object.addPublisher);
            }
            if (object.updatePublisher != null) {
                if (typeof object.updatePublisher !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.updatePublisher: object expected");
                message.updatePublisher = $root.pyth_lazer_transaction.UpdatePublisher.fromObject(object.updatePublisher);
            }
            if (object.addFeed != null) {
                if (typeof object.addFeed !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.addFeed: object expected");
                message.addFeed = $root.pyth_lazer_transaction.AddFeed.fromObject(object.addFeed);
            }
            if (object.updateFeed != null) {
                if (typeof object.updateFeed !== "object")
                    throw TypeError(".pyth_lazer_transaction.GovernanceDirective.updateFeed: object expected");
                message.updateFeed = $root.pyth_lazer_transaction.UpdateFeed.fromObject(object.updateFeed);
            }
            return message;
        };
        ...
        GovernanceDirective.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.shardFilter != null && message.hasOwnProperty("shardFilter")) {
                object.shardFilter = $root.pyth_lazer_transaction.ShardFilter.toObject(message.shardFilter, options);
                if (options.oneofs)
                    object._shardFilter = "shardFilter";
            }
            if (message.createShard != null && message.hasOwnProperty("createShard")) {
                object.createShard = $root.pyth_lazer_transaction.CreateShard.toObject(message.createShard, options);
                if (options.oneofs)
                    object.action = "createShard";
            }
            if (message.addGovernanceSource != null && message.hasOwnProperty("addGovernanceSource")) {
                object.addGovernanceSource = $root.pyth_lazer_transaction.AddGovernanceSource.toObject(message.addGovernanceSource, options);
                if (options.oneofs)
                    object.action = "addGovernanceSource";
            }
            if (message.updateGovernanceSource != null && message.hasOwnProperty("updateGovernanceSource")) {
                object.updateGovernanceSource = $root.pyth_lazer_transaction.UpdateGovernanceSource.toObject(message.updateGovernanceSource, options);
                if (options.oneofs)
                    object.action = "updateGovernanceSource";
            }
            if (message.setShardName != null && message.hasOwnProperty("setShardName")) {
                object.setShardName = $root.pyth_lazer_transaction.SetShardName.toObject(message.setShardName, options);
                if (options.oneofs)
                    object.action = "setShardName";
            }
            if (message.setShardGroup != null && message.hasOwnProperty("setShardGroup")) {
                object.setShardGroup = $root.pyth_lazer_transaction.SetShardGroup.toObject(message.setShardGroup, options);
                if (options.oneofs)
                    object.action = "setShardGroup";
            }
            if (message.resetLastSequenceNo != null && message.hasOwnProperty("resetLastSequenceNo")) {
                object.resetLastSequenceNo = $root.pyth_lazer_transaction.ResetLastSequenceNo.toObject(message.resetLastSequenceNo, options);
                if (options.oneofs)
                    object.action = "resetLastSequenceNo";
            }
            if (message.addPublisher != null && message.hasOwnProperty("addPublisher")) {
                object.addPublisher = $root.pyth_lazer_transaction.AddPublisher.toObject(message.addPublisher, options);
                if (options.oneofs)
                    object.action = "addPublisher";
            }
            if (message.updatePublisher != null && message.hasOwnProperty("updatePublisher")) {
                object.updatePublisher = $root.pyth_lazer_transaction.UpdatePublisher.toObject(message.updatePublisher, options);
                if (options.oneofs)
                    object.action = "updatePublisher";
            }
            if (message.addFeed != null && message.hasOwnProperty("addFeed")) {
                object.addFeed = $root.pyth_lazer_transaction.AddFeed.toObject(message.addFeed, options);
                if (options.oneofs)
                    object.action = "addFeed";
            }
            if (message.updateFeed != null && message.hasOwnProperty("updateFeed")) {
                object.updateFeed = $root.pyth_lazer_transaction.UpdateFeed.toObject(message.updateFeed, options);
                if (options.oneofs)
                    object.action = "updateFeed";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.Permissions = (function() {
         ...
         * @instance
         */
        Object.defineProperty(Permissions.prototype, "_allUpdateGovernanceSourceActions", {
            get: $util.oneOfGetter($oneOfFields = ["allUpdateGovernanceSourceActions"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        Permissions.encode = function encode(message, writer) {
            ...
            if (message.shardActions != null && message.shardActions.length) {
                ...
                for (let i = 0; i < message.shardActions.length; ++i)
                    writer.int32(message.shardActions[i]);
                writer.ldelim();
            }
            if (message.allUpdateGovernanceSourceActions != null && Object.hasOwnProperty.call(message, "allUpdateGovernanceSourceActions"))
                writer.uint32(/* id 3, wireType 0 =*/24).bool(message.allUpdateGovernanceSourceActions);
            if (message.updateGovernanceSourceActions != null && message.updateGovernanceSourceActions.length) {
                writer.uint32(/* id 4, wireType 2 =*/34).fork();
                for (let i = 0; i < message.updateGovernanceSourceActions.length; ++i)
                    writer.int32(message.updateGovernanceSourceActions[i]);
                writer.ldelim();
            }
            if (message.allUpdatePublisherAction != null && Object.hasOwnProperty.call(message, "allUpdatePublisherAction"))
                writer.uint32(/* id 5, wireType 0 =*/40).bool(message.allUpdatePublisherAction);
            if (message.updatePublisherActions != null && message.updatePublisherActions.length) {
                writer.uint32(/* id 6, wireType 2 =*/50).fork();
                for (let i = 0; i < message.updatePublisherActions.length; ++i)
                    writer.int32(message.updatePublisherActions[i]);
                writer.ldelim();
            }
            if (message.allUpdateFeedActions != null && Object.hasOwnProperty.call(message, "allUpdateFeedActions"))
                writer.uint32(/* id 7, wireType 0 =*/56).bool(message.allUpdateFeedActions);
            if (message.updateFeedActions != null && message.updateFeedActions.length) {
                writer.uint32(/* id 8, wireType 2 =*/66).fork();
                for (let i = 0; i < message.updateFeedActions.length; ++i)
        ...
        Permissions.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.Permissions();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 4: {
                        if (!(message.updateGovernanceSourceActions && message.updateGovernanceSourceActions.length))
                ...
                case 6: {
                        if (!(message.updatePublisherActions && message.updatePublisherActions.length))
        ...
        Permissions.verify = function verify(message) {
            ...
            if (message.shardActions != null && message.hasOwnProperty("shardActions")) {
            ...
            if (message.allUpdateGovernanceSourceActions != null && message.hasOwnProperty("allUpdateGovernanceSourceActions")) {
            ...
            if (message.updateGovernanceSourceActions != null && message.hasOwnProperty("updateGovernanceSourceActions")) {
            ...
            if (message.allUpdatePublisherAction != null && message.hasOwnProperty("allUpdatePublisherAction")) {
            ...
            if (message.updatePublisherActions != null && message.hasOwnProperty("updatePublisherActions")) {
            ...
            if (message.allUpdateFeedActions != null && message.hasOwnProperty("allUpdateFeedActions")) {
            ...
            if (message.updateFeedActions != null && message.hasOwnProperty("updateFeedActions")) {
        ...
        Permissions.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.Permissions)
                return object;
            let message = new $root.pyth_lazer_transaction.Permissions();
            ...
            if (object.shardActions) {
                if (!Array.isArray(object.shardActions))
                    throw TypeError(".pyth_lazer_transaction.Permissions.shardActions: array expected");
                message.shardActions = [];
                for (let i = 0; i < object.shardActions.length; ++i)
            ...
            if (object.allUpdateGovernanceSourceActions != null)
                message.allUpdateGovernanceSourceActions = Boolean(object.allUpdateGovernanceSourceActions);
            if (object.updateGovernanceSourceActions) {
                if (!Array.isArray(object.updateGovernanceSourceActions))
                    throw TypeError(".pyth_lazer_transaction.Permissions.updateGovernanceSourceActions: array expected");
                message.updateGovernanceSourceActions = [];
                for (let i = 0; i < object.updateGovernanceSourceActions.length; ++i)
                    switch (object.updateGovernanceSourceActions[i]) {
                    default:
                        if (typeof object.updateGovernanceSourceActions[i] === "number") {
                            message.updateGovernanceSourceActions[i] = object.updateGovernanceSourceActions[i];
                            break;
                        }
            ...
            if (object.allUpdatePublisherAction != null)
                message.allUpdatePublisherAction = Boolean(object.allUpdatePublisherAction);
            if (object.updatePublisherActions) {
                if (!Array.isArray(object.updatePublisherActions))
                    throw TypeError(".pyth_lazer_transaction.Permissions.updatePublisherActions: array expected");
                message.updatePublisherActions = [];
                for (let i = 0; i < object.updatePublisherActions.length; ++i)
                    switch (object.updatePublisherActions[i]) {
                    default:
                        if (typeof object.updatePublisherActions[i] === "number") {
                            message.updatePublisherActions[i] = object.updatePublisherActions[i];
                            break;
                        }
            ...
            if (object.updateFeedActions) {
                if (!Array.isArray(object.updateFeedActions))
                    throw TypeError(".pyth_lazer_transaction.Permissions.updateFeedActions: array expected");
                message.updateFeedActions = [];
                for (let i = 0; i < object.updateFeedActions.length; ++i)
        ...
        Permissions.toObject = function toObject(message, options) {
            ...
            if (message.allActions != null && message.hasOwnProperty("allActions")) {
                ...
                if (options.oneofs)
                    object._allActions = "allActions";
            }
            if (message.shardActions && message.shardActions.length) {
                object.shardActions = [];
                for (let j = 0; j < message.shardActions.length; ++j)
                    object.shardActions[j] = options.enums === String ? $root.pyth_lazer_transaction.Permissions.ShardAction[message.shardActions[j]] === undefined ? message.shardActions[j] : $root.pyth_lazer_transaction.Permissions.ShardAction[message.shardActions[j]] : message.shardActions[j];
            }
            if (message.allUpdateGovernanceSourceActions != null && message.hasOwnProperty("allUpdateGovernanceSourceActions")) {
                object.allUpdateGovernanceSourceActions = message.allUpdateGovernanceSourceActions;
                if (options.oneofs)
                    object._allUpdateGovernanceSourceActions = "allUpdateGovernanceSourceActions";
            }
            if (message.updateGovernanceSourceActions && message.updateGovernanceSourceActions.length) {
                object.updateGovernanceSourceActions = [];
                for (let j = 0; j < message.updateGovernanceSourceActions.length; ++j)
                    object.updateGovernanceSourceActions[j] = options.enums === String ? $root.pyth_lazer_transaction.Permissions.UpdateGovernanceSourceAction[message.updateGovernanceSourceActions[j]] === undefined ? message.updateGovernanceSourceActions[j] : $root.pyth_lazer_transaction.Permissions.UpdateGovernanceSourceAction[message.updateGovernanceSourceActions[j]] : message.updateGovernanceSourceActions[j];
            }
            if (message.allUpdatePublisherAction != null && message.hasOwnProperty("allUpdatePublisherAction")) {
            ...
            if (message.updatePublisherActions && message.updatePublisherActions.length) {
                object.updatePublisherActions = [];
                for (let j = 0; j < message.updatePublisherActions.length; ++j)
                    object.updatePublisherActions[j] = options.enums === String ? $root.pyth_lazer_transaction.Permissions.UpdatePublisherAction[message.updatePublisherActions[j]] === undefined ? message.updatePublisherActions[j] : $root.pyth_lazer_transaction.Permissions.UpdatePublisherAction[message.updatePublisherActions[j]] : message.updatePublisherActions[j];
            }
            if (message.allUpdateFeedActions != null && message.hasOwnProperty("allUpdateFeedActions")) {
            ...
            if (message.updateFeedActions && message.updateFeedActions.length) {
                object.updateFeedActions = [];
                for (let j = 0; j < message.updateFeedActions.length; ++j)
                    object.updateFeedActions[j] = options.enums === String ? $root.pyth_lazer_transaction.Permissions.UpdateFeedAction[message.updateFeedActions[j]] === undefined ? message.updateFeedActions[j] : $root.pyth_lazer_transaction.Permissions.UpdateFeedAction[message.updateFeedActions[j]] : message.updateFeedActions[j];
            }
            return object;
        };
        ...
        Permissions.UpdateGovernanceSourceAction = (function() {
            const valuesById = {}, values = Object.create(valuesById);
            values[valuesById[0] = "UPDATE_GOVERNANCE_SOURCE_ACTION_UNSPECIFIED"] = 0;
    ...
    pyth_lazer_transaction.GovernanceSource = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GovernanceSource.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        GovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceSource();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        GovernanceSource.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.singleEd25519 != null && message.hasOwnProperty("singleEd25519")) {
                properties.source = 1;
                {
                    let error = $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519.verify(message.singleEd25519);
                    if (error)
        ...
        GovernanceSource.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.GovernanceSource)
                return object;
            let message = new $root.pyth_lazer_transaction.GovernanceSource();
        ...
        GovernanceSource.SingleEd25519 = (function() {
             ...
             * @returns {$protobuf.Writer} Writer
             */
            SingleEd25519.encodeDelimited = function encodeDelimited(message, writer) {
                return this.encode(message, writer).ldelim();
            };
            ...
            SingleEd25519.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            SingleEd25519.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519)
                    return object;
                let message = new $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519();
            ...
            SingleEd25519.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/pyth_lazer_transaction.GovernanceSource.SingleEd25519";
            };
    ...
    pyth_lazer_transaction.CreateShard = (function() {
        ...
        CreateShard.encode = function encode(message, writer) {
            ...
            if (message.shardGroup != null && Object.hasOwnProperty.call(message, "shardGroup"))
                writer.uint32(/* id 2, wireType 2 =*/18).string(message.shardGroup);
            if (message.minRate != null && Object.hasOwnProperty.call(message, "minRate"))
                $root.google.protobuf.Duration.encode(message.minRate, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            return writer;
        };
        ...
        CreateShard.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.CreateShard();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 3: {
                        message.minRate = $root.google.protobuf.Duration.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        CreateShard.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.CreateShard)
                return object;
            let message = new $root.pyth_lazer_transaction.CreateShard();
            ...
            if (object.minRate != null) {
                if (typeof object.minRate !== "object")
                    throw TypeError(".pyth_lazer_transaction.CreateShard.minRate: object expected");
                message.minRate = $root.google.protobuf.Duration.fromObject(object.minRate);
            }
            return message;
        };
        ...
        CreateShard.toObject = function toObject(message, options) {
            ...
            if (message.shardId != null && message.hasOwnProperty("shardId")) {
                ...
                if (options.oneofs)
                    object._shardId = "shardId";
            }
            if (message.shardGroup != null && message.hasOwnProperty("shardGroup")) {
                object.shardGroup = message.shardGroup;
                if (options.oneofs)
                    object._shardGroup = "shardGroup";
            }
            if (message.minRate != null && message.hasOwnProperty("minRate")) {
                object.minRate = $root.google.protobuf.Duration.toObject(message.minRate, options);
                if (options.oneofs)
                    object._minRate = "minRate";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.AddGovernanceSource = (function() {
        ...
        AddGovernanceSource.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.newSource != null && Object.hasOwnProperty.call(message, "newSource"))
                $root.pyth_lazer_transaction.GovernanceSource.encode(message.newSource, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.permissions != null && Object.hasOwnProperty.call(message, "permissions"))
                $root.pyth_lazer_transaction.Permissions.encode(message.permissions, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AddGovernanceSource.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AddGovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddGovernanceSource();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.newSource = $root.pyth_lazer_transaction.GovernanceSource.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.permissions = $root.pyth_lazer_transaction.Permissions.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        AddGovernanceSource.verify = function verify(message) {
            ...
            if (message.newSource != null && message.hasOwnProperty("newSource")) {
                ...
                {
                    let error = $root.pyth_lazer_transaction.GovernanceSource.verify(message.newSource);
                    if (error)
            ...
            if (message.permissions != null && message.hasOwnProperty("permissions")) {
                ...
                {
                    let error = $root.pyth_lazer_transaction.Permissions.verify(message.permissions);
                    if (error)
        ...
        AddGovernanceSource.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.AddGovernanceSource)
                return object;
            let message = new $root.pyth_lazer_transaction.AddGovernanceSource();
            if (object.newSource != null) {
                if (typeof object.newSource !== "object")
                    throw TypeError(".pyth_lazer_transaction.AddGovernanceSource.newSource: object expected");
                message.newSource = $root.pyth_lazer_transaction.GovernanceSource.fromObject(object.newSource);
            }
            if (object.permissions != null) {
                if (typeof object.permissions !== "object")
                    throw TypeError(".pyth_lazer_transaction.AddGovernanceSource.permissions: object expected");
                message.permissions = $root.pyth_lazer_transaction.Permissions.fromObject(object.permissions);
            }
            return message;
        };
        ...
        AddGovernanceSource.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.newSource != null && message.hasOwnProperty("newSource")) {
                object.newSource = $root.pyth_lazer_transaction.GovernanceSource.toObject(message.newSource, options);
                if (options.oneofs)
                    object._newSource = "newSource";
            }
            if (message.permissions != null && message.hasOwnProperty("permissions")) {
                object.permissions = $root.pyth_lazer_transaction.Permissions.toObject(message.permissions, options);
                if (options.oneofs)
    ...
    pyth_lazer_transaction.UpdateGovernanceSource = (function() {
        ...
        Object.defineProperty(UpdateGovernanceSource.prototype, "action", {
            get: $util.oneOfGetter($oneOfFields = ["setGovernanceSourcePermissions", "removeGovernanceSource"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        UpdateGovernanceSource.encode = function encode(message, writer) {
            ...
            if (message.source != null && Object.hasOwnProperty.call(message, "source"))
                $root.pyth_lazer_transaction.GovernanceSource.encode(message.source, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.setGovernanceSourcePermissions != null && Object.hasOwnProperty.call(message, "setGovernanceSourcePermissions"))
                $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.encode(message.setGovernanceSourcePermissions, writer.uint32(/* id 101, wireType 2 =*/810).fork()).ldelim();
            if (message.removeGovernanceSource != null && Object.hasOwnProperty.call(message, "removeGovernanceSource"))
                $root.google.protobuf.Empty.encode(message.removeGovernanceSource, writer.uint32(/* id 199, wireType 2 =*/1594).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UpdateGovernanceSource.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        UpdateGovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateGovernanceSource();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 101: {
                        message.setGovernanceSourcePermissions = $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.decode(reader, reader.uint32());
                        break;
                    }
                case 199: {
                        message.removeGovernanceSource = $root.google.protobuf.Empty.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        UpdateGovernanceSource.verify = function verify(message) {
            ...
            if (message.setGovernanceSourcePermissions != null && message.hasOwnProperty("setGovernanceSourcePermissions")) {
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.verify(message.setGovernanceSourcePermissions);
                    if (error)
                        return "setGovernanceSourcePermissions." + error;
                }
            }
            if (message.removeGovernanceSource != null && message.hasOwnProperty("removeGovernanceSource")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.google.protobuf.Empty.verify(message.removeGovernanceSource);
                    if (error)
                        return "removeGovernanceSource." + error;
                }
            }
            return null;
        };
        ...
        UpdateGovernanceSource.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.UpdateGovernanceSource)
                return object;
            let message = new $root.pyth_lazer_transaction.UpdateGovernanceSource();
            if (object.source != null) {
                if (typeof object.source !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateGovernanceSource.source: object expected");
                message.source = $root.pyth_lazer_transaction.GovernanceSource.fromObject(object.source);
            }
            if (object.setGovernanceSourcePermissions != null) {
                if (typeof object.setGovernanceSourcePermissions !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateGovernanceSource.setGovernanceSourcePermissions: object expected");
                message.setGovernanceSourcePermissions = $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.fromObject(object.setGovernanceSourcePermissions);
            }
            if (object.removeGovernanceSource != null) {
                if (typeof object.removeGovernanceSource !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateGovernanceSource.removeGovernanceSource: object expected");
                message.removeGovernanceSource = $root.google.protobuf.Empty.fromObject(object.removeGovernanceSource);
            }
            return message;
        };
        ...
        UpdateGovernanceSource.toObject = function toObject(message, options) {
            ...
            if (message.setGovernanceSourcePermissions != null && message.hasOwnProperty("setGovernanceSourcePermissions")) {
                object.setGovernanceSourcePermissions = $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.toObject(message.setGovernanceSourcePermissions, options);
                if (options.oneofs)
                    object.action = "setGovernanceSourcePermissions";
            }
            if (message.removeGovernanceSource != null && message.hasOwnProperty("removeGovernanceSource")) {
                object.removeGovernanceSource = $root.google.protobuf.Empty.toObject(message.removeGovernanceSource, options);
                if (options.oneofs)
                    object.action = "removeGovernanceSource";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.SetGovernanceSourcePermissions = (function() {
         ...
         * @instance
         */
        Object.defineProperty(SetGovernanceSourcePermissions.prototype, "_permissions", {
            get: $util.oneOfGetter($oneOfFields = ["permissions"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        SetGovernanceSourcePermissions.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.permissions != null && Object.hasOwnProperty.call(message, "permissions"))
                $root.pyth_lazer_transaction.Permissions.encode(message.permissions, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SetGovernanceSourcePermissions.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SetGovernanceSourcePermissions.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetGovernanceSourcePermissions();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        SetGovernanceSourcePermissions.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        SetGovernanceSourcePermissions.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetGovernanceSourcePermissions)
                return object;
            let message = new $root.pyth_lazer_transaction.SetGovernanceSourcePermissions();
            if (object.permissions != null) {
                if (typeof object.permissions !== "object")
                    throw TypeError(".pyth_lazer_transaction.SetGovernanceSourcePermissions.permissions: object expected");
                message.permissions = $root.pyth_lazer_transaction.Permissions.fromObject(object.permissions);
            }
            return message;
        };
         ...
         * @returns {Object.<string,*>} Plain object
         */
        SetGovernanceSourcePermissions.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            let object = {};
            if (message.permissions != null && message.hasOwnProperty("permissions")) {
         ...
         * @returns {string} The default type url
         */
        SetGovernanceSourcePermissions.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/pyth_lazer_transaction.SetGovernanceSourcePermissions";
        };
    ...
    pyth_lazer_transaction.SetShardName = (function() {
        ...
        SetShardName.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.shardName != null && Object.hasOwnProperty.call(message, "shardName"))
        ...
        SetShardName.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetShardName();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetShardName.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetShardName)
                return object;
            let message = new $root.pyth_lazer_transaction.SetShardName();
    ...
    pyth_lazer_transaction.SetShardGroup = (function() {
        ...
        SetShardGroup.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetShardGroup();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetShardGroup.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetShardGroup)
                return object;
            let message = new $root.pyth_lazer_transaction.SetShardGroup();
            if (object.shardGroup != null)
                message.shardGroup = String(object.shardGroup);
            return message;
        };
    ...
    pyth_lazer_transaction.ResetLastSequenceNo = (function() {
        ...
        ResetLastSequenceNo.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.lastSequenceNo != null && Object.hasOwnProperty.call(message, "lastSequenceNo"))
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ResetLastSequenceNo.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        ResetLastSequenceNo.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ResetLastSequenceNo();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ResetLastSequenceNo.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.lastSequenceNo != null && message.hasOwnProperty("lastSequenceNo")) {
                properties._lastSequenceNo = 1;
                if (!$util.isInteger(message.lastSequenceNo) && !(message.lastSequenceNo && $util.isInteger(message.lastSequenceNo.low) && $util.isInteger(message.lastSequenceNo.high)))
        ...
        ResetLastSequenceNo.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.ResetLastSequenceNo)
                return object;
            let message = new $root.pyth_lazer_transaction.ResetLastSequenceNo();
            if (object.lastSequenceNo != null)
                if ($util.Long)
                    (message.lastSequenceNo = $util.Long.fromValue(object.lastSequenceNo)).unsigned = true;
                    ...
                    message.lastSequenceNo = new $util.LongBits(object.lastSequenceNo.low >>> 0, object.lastSequenceNo.high >>> 0).toNumber(true);
            return message;
        };
        ...
        ResetLastSequenceNo.toObject = function toObject(message, options) {
            ...
            if (message.lastSequenceNo != null && message.hasOwnProperty("lastSequenceNo")) {
                if (typeof message.lastSequenceNo === "number")
                    object.lastSequenceNo = options.longs === String ? String(message.lastSequenceNo) : message.lastSequenceNo;
                else
                    object.lastSequenceNo = options.longs === String ? $util.Long.prototype.toString.call(message.lastSequenceNo) : options.longs === Number ? new $util.LongBits(message.lastSequenceNo.low >>> 0, message.lastSequenceNo.high >>> 0).toNumber(true) : message.lastSequenceNo;
                if (options.oneofs)
                    object._lastSequenceNo = "lastSequenceNo";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.AddPublisher = (function() {
        ...
        AddPublisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddPublisher();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        AddPublisher.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.AddPublisher)
                return object;
            let message = new $root.pyth_lazer_transaction.AddPublisher();
            ...
            if (object.publicKeys) {
                if (!Array.isArray(object.publicKeys))
                    throw TypeError(".pyth_lazer_transaction.AddPublisher.publicKeys: array expected");
                message.publicKeys = [];
        ...
        AddPublisher.toObject = function toObject(message, options) {
            ...
            if (message.publisherId != null && message.hasOwnProperty("publisherId")) {
                ...
                if (options.oneofs)
                    object._publisherId = "publisherId";
            }
            if (message.name != null && message.hasOwnProperty("name")) {
    ...
    pyth_lazer_transaction.UpdatePublisher = (function() {
        ...
        Object.defineProperty(UpdatePublisher.prototype, "action", {
            get: $util.oneOfGetter($oneOfFields = ["setPublisherName", "addPublisherPublicKeys", "removePublisherPublicKeys", "setPublisherPublicKeys", "setPublisherActive", "removePublisher"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        UpdatePublisher.encode = function encode(message, writer) {
            ...
            if (message.publisherId != null && Object.hasOwnProperty.call(message, "publisherId"))
                writer.uint32(/* id 1, wireType 0 =*/8).uint32(message.publisherId);
            if (message.setPublisherName != null && Object.hasOwnProperty.call(message, "setPublisherName"))
                $root.pyth_lazer_transaction.SetPublisherName.encode(message.setPublisherName, writer.uint32(/* id 101, wireType 2 =*/810).fork()).ldelim();
            if (message.addPublisherPublicKeys != null && Object.hasOwnProperty.call(message, "addPublisherPublicKeys"))
                $root.pyth_lazer_transaction.AddPublisherPublicKeys.encode(message.addPublisherPublicKeys, writer.uint32(/* id 102, wireType 2 =*/818).fork()).ldelim();
            if (message.removePublisherPublicKeys != null && Object.hasOwnProperty.call(message, "removePublisherPublicKeys"))
                $root.pyth_lazer_transaction.RemovePublisherPublicKeys.encode(message.removePublisherPublicKeys, writer.uint32(/* id 103, wireType 2 =*/826).fork()).ldelim();
            if (message.setPublisherPublicKeys != null && Object.hasOwnProperty.call(message, "setPublisherPublicKeys"))
                $root.pyth_lazer_transaction.SetPublisherPublicKeys.encode(message.setPublisherPublicKeys, writer.uint32(/* id 104, wireType 2 =*/834).fork()).ldelim();
            if (message.setPublisherActive != null && Object.hasOwnProperty.call(message, "setPublisherActive"))
                $root.pyth_lazer_transaction.SetPublisherActive.encode(message.setPublisherActive, writer.uint32(/* id 105, wireType 2 =*/842).fork()).ldelim();
            if (message.removePublisher != null && Object.hasOwnProperty.call(message, "removePublisher"))
                $root.google.protobuf.Empty.encode(message.removePublisher, writer.uint32(/* id 199, wireType 2 =*/1594).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UpdatePublisher.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        UpdatePublisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdatePublisher();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 101: {
                        message.setPublisherName = $root.pyth_lazer_transaction.SetPublisherName.decode(reader, reader.uint32());
                        break;
                    }
                case 102: {
                        message.addPublisherPublicKeys = $root.pyth_lazer_transaction.AddPublisherPublicKeys.decode(reader, reader.uint32());
                        break;
                    }
                case 103: {
                        message.removePublisherPublicKeys = $root.pyth_lazer_transaction.RemovePublisherPublicKeys.decode(reader, reader.uint32());
                        break;
                    }
                case 104: {
                        message.setPublisherPublicKeys = $root.pyth_lazer_transaction.SetPublisherPublicKeys.decode(reader, reader.uint32());
                        break;
                    }
                case 105: {
                        message.setPublisherActive = $root.pyth_lazer_transaction.SetPublisherActive.decode(reader, reader.uint32());
                        break;
                    }
                case 199: {
                        message.removePublisher = $root.google.protobuf.Empty.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        UpdatePublisher.verify = function verify(message) {
            ...
            if (message.setPublisherName != null && message.hasOwnProperty("setPublisherName")) {
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetPublisherName.verify(message.setPublisherName);
                    if (error)
                        return "setPublisherName." + error;
                }
            }
            if (message.addPublisherPublicKeys != null && message.hasOwnProperty("addPublisherPublicKeys")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.AddPublisherPublicKeys.verify(message.addPublisherPublicKeys);
                    if (error)
                        return "addPublisherPublicKeys." + error;
                }
            }
            if (message.removePublisherPublicKeys != null && message.hasOwnProperty("removePublisherPublicKeys")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.RemovePublisherPublicKeys.verify(message.removePublisherPublicKeys);
                    if (error)
                        return "removePublisherPublicKeys." + error;
                }
            }
            if (message.setPublisherPublicKeys != null && message.hasOwnProperty("setPublisherPublicKeys")) {
                ...
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetPublisherPublicKeys.verify(message.setPublisherPublicKeys);
                    if (error)
                        return "setPublisherPublicKeys." + error;
                }
            }
            if (message.setPublisherActive != null && message.hasOwnProperty("setPublisherActive")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.SetPublisherActive.verify(message.setPublisherActive);
                    if (error)
                        return "setPublisherActive." + error;
                }
            }
            if (message.removePublisher != null && message.hasOwnProperty("removePublisher")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.google.protobuf.Empty.verify(message.removePublisher);
                    if (error)
                        return "removePublisher." + error;
                }
            }
            return null;
        };
        ...
        UpdatePublisher.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.UpdatePublisher)
                return object;
            let message = new $root.pyth_lazer_transaction.UpdatePublisher();
            if (object.publisherId != null)
                message.publisherId = object.publisherId >>> 0;
            if (object.setPublisherName != null) {
                if (typeof object.setPublisherName !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.setPublisherName: object expected");
                message.setPublisherName = $root.pyth_lazer_transaction.SetPublisherName.fromObject(object.setPublisherName);
            }
            if (object.addPublisherPublicKeys != null) {
                if (typeof object.addPublisherPublicKeys !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.addPublisherPublicKeys: object expected");
                message.addPublisherPublicKeys = $root.pyth_lazer_transaction.AddPublisherPublicKeys.fromObject(object.addPublisherPublicKeys);
            }
            if (object.removePublisherPublicKeys != null) {
                if (typeof object.removePublisherPublicKeys !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.removePublisherPublicKeys: object expected");
                message.removePublisherPublicKeys = $root.pyth_lazer_transaction.RemovePublisherPublicKeys.fromObject(object.removePublisherPublicKeys);
            }
            if (object.setPublisherPublicKeys != null) {
                if (typeof object.setPublisherPublicKeys !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.setPublisherPublicKeys: object expected");
                message.setPublisherPublicKeys = $root.pyth_lazer_transaction.SetPublisherPublicKeys.fromObject(object.setPublisherPublicKeys);
            }
            if (object.setPublisherActive != null) {
                if (typeof object.setPublisherActive !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.setPublisherActive: object expected");
                message.setPublisherActive = $root.pyth_lazer_transaction.SetPublisherActive.fromObject(object.setPublisherActive);
            }
            if (object.removePublisher != null) {
                if (typeof object.removePublisher !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdatePublisher.removePublisher: object expected");
                message.removePublisher = $root.google.protobuf.Empty.fromObject(object.removePublisher);
            }
            return message;
        };
        ...
        UpdatePublisher.toObject = function toObject(message, options) {
            ...
            if (message.setPublisherName != null && message.hasOwnProperty("setPublisherName")) {
                object.setPublisherName = $root.pyth_lazer_transaction.SetPublisherName.toObject(message.setPublisherName, options);
                if (options.oneofs)
                    object.action = "setPublisherName";
            }
            if (message.addPublisherPublicKeys != null && message.hasOwnProperty("addPublisherPublicKeys")) {
                object.addPublisherPublicKeys = $root.pyth_lazer_transaction.AddPublisherPublicKeys.toObject(message.addPublisherPublicKeys, options);
                if (options.oneofs)
                    object.action = "addPublisherPublicKeys";
            }
            if (message.removePublisherPublicKeys != null && message.hasOwnProperty("removePublisherPublicKeys")) {
                object.removePublisherPublicKeys = $root.pyth_lazer_transaction.RemovePublisherPublicKeys.toObject(message.removePublisherPublicKeys, options);
                if (options.oneofs)
                    object.action = "removePublisherPublicKeys";
            }
            if (message.setPublisherPublicKeys != null && message.hasOwnProperty("setPublisherPublicKeys")) {
                object.setPublisherPublicKeys = $root.pyth_lazer_transaction.SetPublisherPublicKeys.toObject(message.setPublisherPublicKeys, options);
                if (options.oneofs)
                    object.action = "setPublisherPublicKeys";
            }
            if (message.setPublisherActive != null && message.hasOwnProperty("setPublisherActive")) {
                object.setPublisherActive = $root.pyth_lazer_transaction.SetPublisherActive.toObject(message.setPublisherActive, options);
                if (options.oneofs)
                    object.action = "setPublisherActive";
            }
            if (message.removePublisher != null && message.hasOwnProperty("removePublisher")) {
                object.removePublisher = $root.google.protobuf.Empty.toObject(message.removePublisher, options);
                if (options.oneofs)
                    object.action = "removePublisher";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.SetPublisherName = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SetPublisherName.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        SetPublisherName.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherName();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetPublisherName.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetPublisherName)
                return object;
            let message = new $root.pyth_lazer_transaction.SetPublisherName();
            if (object.name != null)
                message.name = String(object.name);
            return message;
        };
    ...
    pyth_lazer_transaction.AddPublisherPublicKeys = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AddPublisherPublicKeys.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AddPublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddPublisherPublicKeys();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        AddPublisherPublicKeys.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.AddPublisherPublicKeys)
                return object;
            let message = new $root.pyth_lazer_transaction.AddPublisherPublicKeys();
            if (object.publicKeys) {
                if (!Array.isArray(object.publicKeys))
                    throw TypeError(".pyth_lazer_transaction.AddPublisherPublicKeys.publicKeys: array expected");
                message.publicKeys = [];
                for (let i = 0; i < object.publicKeys.length; ++i)
                    if (typeof object.publicKeys[i] === "string")
                        $util.base64.decode(object.publicKeys[i], message.publicKeys[i] = $util.newBuffer($util.base64.length(object.publicKeys[i])), 0);
    ...
    pyth_lazer_transaction.RemovePublisherPublicKeys = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        RemovePublisherPublicKeys.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        RemovePublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.RemovePublisherPublicKeys();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        RemovePublisherPublicKeys.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        RemovePublisherPublicKeys.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.RemovePublisherPublicKeys)
                return object;
            let message = new $root.pyth_lazer_transaction.RemovePublisherPublicKeys();
            if (object.publicKeys) {
                if (!Array.isArray(object.publicKeys))
                    throw TypeError(".pyth_lazer_transaction.RemovePublisherPublicKeys.publicKeys: array expected");
                message.publicKeys = [];
                for (let i = 0; i < object.publicKeys.length; ++i)
                    if (typeof object.publicKeys[i] === "string")
                        $util.base64.decode(object.publicKeys[i], message.publicKeys[i] = $util.newBuffer($util.base64.length(object.publicKeys[i])), 0);
        ...
        RemovePublisherPublicKeys.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/pyth_lazer_transaction.RemovePublisherPublicKeys";
        };
    ...
    pyth_lazer_transaction.SetPublisherPublicKeys = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SetPublisherPublicKeys.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        SetPublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherPublicKeys();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetPublisherPublicKeys.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetPublisherPublicKeys)
                return object;
            let message = new $root.pyth_lazer_transaction.SetPublisherPublicKeys();
            if (object.publicKeys) {
                if (!Array.isArray(object.publicKeys))
                    throw TypeError(".pyth_lazer_transaction.SetPublisherPublicKeys.publicKeys: array expected");
                message.publicKeys = [];
                for (let i = 0; i < object.publicKeys.length; ++i)
                    if (typeof object.publicKeys[i] === "string")
                        $util.base64.decode(object.publicKeys[i], message.publicKeys[i] = $util.newBuffer($util.base64.length(object.publicKeys[i])), 0);
    ...
    pyth_lazer_transaction.SetPublisherActive = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SetPublisherActive.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        SetPublisherActive.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherActive();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetPublisherActive.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetPublisherActive)
                return object;
            let message = new $root.pyth_lazer_transaction.SetPublisherActive();
            if (object.isActive != null)
                message.isActive = Boolean(object.isActive);
            return message;
        };
    ...
    pyth_lazer_transaction.AddFeed = (function() {
        ...
        AddFeed.encode = function encode(message, writer) {
            ...
            if (message.permissionedPublishers != null && message.permissionedPublishers.length) {
                ...
                for (let i = 0; i < message.permissionedPublishers.length; ++i)
        ...
        AddFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddFeed();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        message.metadata = $root.pyth_lazer_transaction.DynamicValue.Map.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        if (!(message.permissionedPublishers && message.permissionedPublishers.length))
        ...
        AddFeed.verify = function verify(message) {
            ...
            if (message.metadata != null && message.hasOwnProperty("metadata")) {
                ...
                {
                    let error = $root.pyth_lazer_transaction.DynamicValue.Map.verify(message.metadata);
                    if (error)
                        return "metadata." + error;
                }
            }
            if (message.permissionedPublishers != null && message.hasOwnProperty("permissionedPublishers")) {
        ...
        AddFeed.fromObject = function fromObject(object) {
            ...
            if (object.metadata != null) {
                ...
                message.metadata = $root.pyth_lazer_transaction.DynamicValue.Map.fromObject(object.metadata);
            }
            if (object.permissionedPublishers) {
                if (!Array.isArray(object.permissionedPublishers))
                    throw TypeError(".pyth_lazer_transaction.AddFeed.permissionedPublishers: array expected");
                message.permissionedPublishers = [];
                for (let i = 0; i < object.permissionedPublishers.length; ++i)
                    message.permissionedPublishers[i] = object.permissionedPublishers[i] >>> 0;
            }
            return message;
        };
        ...
        AddFeed.toObject = function toObject(message, options) {
            ...
            if (message.permissionedPublishers && message.permissionedPublishers.length) {
                object.permissionedPublishers = [];
                for (let j = 0; j < message.permissionedPublishers.length; ++j)
    ...
    pyth_lazer_transaction.UpdateFeed = (function() {
        ...
        Object.defineProperty(UpdateFeed.prototype, "action", {
            get: $util.oneOfGetter($oneOfFields = ["updateFeedMetadata", "activateFeed", "deactivateFeed", "removeFeed"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        UpdateFeed.encode = function encode(message, writer) {
            ...
            if (message.activateFeed != null && Object.hasOwnProperty.call(message, "activateFeed"))
                $root.pyth_lazer_transaction.ActivateFeed.encode(message.activateFeed, writer.uint32(/* id 102, wireType 2 =*/818).fork()).ldelim();
            if (message.deactivateFeed != null && Object.hasOwnProperty.call(message, "deactivateFeed"))
                $root.pyth_lazer_transaction.DeactivateFeed.encode(message.deactivateFeed, writer.uint32(/* id 103, wireType 2 =*/826).fork()).ldelim();
            if (message.removeFeed != null && Object.hasOwnProperty.call(message, "removeFeed"))
                $root.google.protobuf.Empty.encode(message.removeFeed, writer.uint32(/* id 199, wireType 2 =*/1594).fork()).ldelim();
            return writer;
        };
        ...
        UpdateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateFeed();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 101: {
                        message.updateFeedMetadata = $root.pyth_lazer_transaction.UpdateFeedMetadata.decode(reader, reader.uint32());
                        break;
                    }
                case 102: {
                        message.activateFeed = $root.pyth_lazer_transaction.ActivateFeed.decode(reader, reader.uint32());
                        break;
                    }
                case 103: {
                        message.deactivateFeed = $root.pyth_lazer_transaction.DeactivateFeed.decode(reader, reader.uint32());
                        break;
                    }
                case 199: {
                        message.removeFeed = $root.google.protobuf.Empty.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        UpdateFeed.verify = function verify(message) {
            ...
            if (message.updateFeedMetadata != null && message.hasOwnProperty("updateFeedMetadata")) {
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.UpdateFeedMetadata.verify(message.updateFeedMetadata);
                    if (error)
                        return "updateFeedMetadata." + error;
                }
            }
            if (message.activateFeed != null && message.hasOwnProperty("activateFeed")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.ActivateFeed.verify(message.activateFeed);
                    if (error)
                        return "activateFeed." + error;
                }
            }
            if (message.deactivateFeed != null && message.hasOwnProperty("deactivateFeed")) {
                if (properties.action === 1)
                    return "action: multiple values";
                properties.action = 1;
                {
                    let error = $root.pyth_lazer_transaction.DeactivateFeed.verify(message.deactivateFeed);
                    if (error)
                        return "deactivateFeed." + error;
                }
            }
            if (message.removeFeed != null && message.hasOwnProperty("removeFeed")) {
                ...
                properties.action = 1;
                {
                    let error = $root.google.protobuf.Empty.verify(message.removeFeed);
                    if (error)
                        return "removeFeed." + error;
                }
            }
            return null;
        };
        ...
        UpdateFeed.fromObject = function fromObject(object) {
            ...
            if (object.updateFeedMetadata != null) {
                ...
                message.updateFeedMetadata = $root.pyth_lazer_transaction.UpdateFeedMetadata.fromObject(object.updateFeedMetadata);
            }
            if (object.activateFeed != null) {
                if (typeof object.activateFeed !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateFeed.activateFeed: object expected");
                message.activateFeed = $root.pyth_lazer_transaction.ActivateFeed.fromObject(object.activateFeed);
            }
            if (object.deactivateFeed != null) {
                if (typeof object.deactivateFeed !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateFeed.deactivateFeed: object expected");
                message.deactivateFeed = $root.pyth_lazer_transaction.DeactivateFeed.fromObject(object.deactivateFeed);
            }
            if (object.removeFeed != null) {
                if (typeof object.removeFeed !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateFeed.removeFeed: object expected");
                message.removeFeed = $root.google.protobuf.Empty.fromObject(object.removeFeed);
            }
            return message;
        };
        ...
        UpdateFeed.toObject = function toObject(message, options) {
            ...
            if (message.updateFeedMetadata != null && message.hasOwnProperty("updateFeedMetadata")) {
                ...
                if (options.oneofs)
                    object.action = "updateFeedMetadata";
            }
            if (message.activateFeed != null && message.hasOwnProperty("activateFeed")) {
                object.activateFeed = $root.pyth_lazer_transaction.ActivateFeed.toObject(message.activateFeed, options);
                if (options.oneofs)
                    object.action = "activateFeed";
            }
            if (message.deactivateFeed != null && message.hasOwnProperty("deactivateFeed")) {
                object.deactivateFeed = $root.pyth_lazer_transaction.DeactivateFeed.toObject(message.deactivateFeed, options);
                if (options.oneofs)
                    object.action = "deactivateFeed";
            }
            if (message.removeFeed != null && message.hasOwnProperty("removeFeed")) {
                object.removeFeed = $root.google.protobuf.Empty.toObject(message.removeFeed, options);
                if (options.oneofs)
                    object.action = "removeFeed";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.UpdateFeedMetadata = (function() {
        ...
        UpdateFeedMetadata.encode = function encode(message, writer) {
            ...
            if (message.value != null && Object.hasOwnProperty.call(message, "value"))
                $root.pyth_lazer_transaction.DynamicValue.encode(message.value, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        UpdateFeedMetadata.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        UpdateFeedMetadata.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateFeedMetadata();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        message.value = $root.pyth_lazer_transaction.DynamicValue.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        UpdateFeedMetadata.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                properties._value = 1;
                {
                    let error = $root.pyth_lazer_transaction.DynamicValue.verify(message.value);
                    if (error)
                        return "value." + error;
                }
            }
        ...
        UpdateFeedMetadata.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.UpdateFeedMetadata)
                return object;
            let message = new $root.pyth_lazer_transaction.UpdateFeedMetadata();
            if (object.name != null)
                message.name = String(object.name);
            if (object.value != null) {
                if (typeof object.value !== "object")
                    throw TypeError(".pyth_lazer_transaction.UpdateFeedMetadata.value: object expected");
                message.value = $root.pyth_lazer_transaction.DynamicValue.fromObject(object.value);
            }
            return message;
        };
        ...
        UpdateFeedMetadata.toObject = function toObject(message, options) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                object.value = $root.pyth_lazer_transaction.DynamicValue.toObject(message.value, options);
                if (options.oneofs)
                    object._value = "value";
            }
            return object;
    ...
    pyth_lazer_transaction.ActivateFeed = (function() {
        ...
        ActivateFeed.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.activationTimestamp != null && Object.hasOwnProperty.call(message, "activationTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.activationTimestamp, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        ActivateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ActivateFeed();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.activationTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        ActivateFeed.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.activationTimestamp != null && message.hasOwnProperty("activationTimestamp")) {
                properties._activationTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.activationTimestamp);
                    if (error)
                        return "activationTimestamp." + error;
                }
            }
            return null;
        };
        ...
        ActivateFeed.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.ActivateFeed)
                return object;
            let message = new $root.pyth_lazer_transaction.ActivateFeed();
            if (object.activationTimestamp != null) {
                if (typeof object.activationTimestamp !== "object")
                    throw TypeError(".pyth_lazer_transaction.ActivateFeed.activationTimestamp: object expected");
                message.activationTimestamp = $root.google.protobuf.Timestamp.fromObject(object.activationTimestamp);
            }
            return message;
        };
        ...
        ActivateFeed.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.activationTimestamp != null && message.hasOwnProperty("activationTimestamp")) {
                object.activationTimestamp = $root.google.protobuf.Timestamp.toObject(message.activationTimestamp, options);
                if (options.oneofs)
                    object._activationTimestamp = "activationTimestamp";
            }
            return object;
        };
    ...
    pyth_lazer_transaction.DeactivateFeed = (function() {
        ...
        DeactivateFeed.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.deactivationTimestamp != null && Object.hasOwnProperty.call(message, "deactivationTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.deactivationTimestamp, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        DeactivateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DeactivateFeed();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.deactivationTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        DeactivateFeed.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.deactivationTimestamp != null && message.hasOwnProperty("deactivationTimestamp")) {
                properties._deactivationTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.deactivationTimestamp);
                    if (error)
                        return "deactivationTimestamp." + error;
                }
            }
            return null;
        };
        ...
        DeactivateFeed.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.DeactivateFeed)
                return object;
            let message = new $root.pyth_lazer_transaction.DeactivateFeed();
            if (object.deactivationTimestamp != null) {
                if (typeof object.deactivationTimestamp !== "object")
                    throw TypeError(".pyth_lazer_transaction.DeactivateFeed.deactivationTimestamp: object expected");
                message.deactivationTimestamp = $root.google.protobuf.Timestamp.fromObject(object.deactivationTimestamp);
            }
            return message;
        };
        ...
        DeactivateFeed.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.deactivationTimestamp != null && message.hasOwnProperty("deactivationTimestamp")) {
                object.deactivationTimestamp = $root.google.protobuf.Timestamp.toObject(message.deactivationTimestamp, options);
                if (options.oneofs)
    ...
    pyth_lazer_transaction.DynamicValue = (function() {
        ...
        Object.defineProperty(DynamicValue.prototype, "value", {
            get: $util.oneOfGetter($oneOfFields = ["stringValue", "doubleValue", "uintValue", "intValue", "boolValue", "bytesValue", "durationValue", "timestampValue", "list", "map"]),
            set: $util.oneOfSetter($oneOfFields)
        });
        ...
        DynamicValue.encode = function encode(message, writer) {
            ...
            if (message.durationValue != null && Object.hasOwnProperty.call(message, "durationValue"))
                $root.google.protobuf.Duration.encode(message.durationValue, writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.timestampValue != null && Object.hasOwnProperty.call(message, "timestampValue"))
                $root.google.protobuf.Timestamp.encode(message.timestampValue, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            if (message.list != null && Object.hasOwnProperty.call(message, "list"))
                $root.pyth_lazer_transaction.DynamicValue.List.encode(message.list, writer.uint32(/* id 9, wireType 2 =*/74).fork()).ldelim();
            if (message.map != null && Object.hasOwnProperty.call(message, "map"))
                $root.pyth_lazer_transaction.DynamicValue.Map.encode(message.map, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            return writer;
        };
        ...
        DynamicValue.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 9: {
                        message.list = $root.pyth_lazer_transaction.DynamicValue.List.decode(reader, reader.uint32());
                        break;
                    }
                case 10: {
                        message.map = $root.pyth_lazer_transaction.DynamicValue.Map.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        DynamicValue.verify = function verify(message) {
            ...
            if (message.durationValue != null && message.hasOwnProperty("durationValue")) {
                ...
                properties.value = 1;
                {
                    let error = $root.google.protobuf.Duration.verify(message.durationValue);
                    if (error)
            ...
            if (message.list != null && message.hasOwnProperty("list")) {
                ...
                properties.value = 1;
                {
                    let error = $root.pyth_lazer_transaction.DynamicValue.List.verify(message.list);
                    if (error)
                        return "list." + error;
                }
            }
            if (message.map != null && message.hasOwnProperty("map")) {
                ...
                properties.value = 1;
                {
                    let error = $root.pyth_lazer_transaction.DynamicValue.Map.verify(message.map);
                    if (error)
                        return "map." + error;
                }
            }
        ...
        DynamicValue.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.DynamicValue)
                return object;
            let message = new $root.pyth_lazer_transaction.DynamicValue();
            ...
            if (object.durationValue != null) {
                if (typeof object.durationValue !== "object")
                    throw TypeError(".pyth_lazer_transaction.DynamicValue.durationValue: object expected");
            ...
            if (object.timestampValue != null) {
                if (typeof object.timestampValue !== "object")
                    throw TypeError(".pyth_lazer_transaction.DynamicValue.timestampValue: object expected");
                message.timestampValue = $root.google.protobuf.Timestamp.fromObject(object.timestampValue);
            }
            if (object.list != null) {
                if (typeof object.list !== "object")
                    throw TypeError(".pyth_lazer_transaction.DynamicValue.list: object expected");
                message.list = $root.pyth_lazer_transaction.DynamicValue.List.fromObject(object.list);
            }
            if (object.map != null) {
                if (typeof object.map !== "object")
                    throw TypeError(".pyth_lazer_transaction.DynamicValue.map: object expected");
                message.map = $root.pyth_lazer_transaction.DynamicValue.Map.fromObject(object.map);
            }
            return message;
        };
        ...
        DynamicValue.toObject = function toObject(message, options) {
            ...
            if (message.list != null && message.hasOwnProperty("list")) {
                object.list = $root.pyth_lazer_transaction.DynamicValue.List.toObject(message.list, options);
                if (options.oneofs)
                    object.value = "list";
            }
            if (message.map != null && message.hasOwnProperty("map")) {
                object.map = $root.pyth_lazer_transaction.DynamicValue.Map.toObject(message.map, options);
                if (options.oneofs)
                    object.value = "map";
            }
            return object;
        ...
        DynamicValue.List = (function() {
            ...
            List.encode = function encode(message, writer) {
                ...
                if (message.items != null && message.items.length)
                    for (let i = 0; i < message.items.length; ++i)
                        $root.pyth_lazer_transaction.DynamicValue.encode(message.items[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            List.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.List();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
                    ...
                    case 1: {
                            if (!(message.items && message.items.length))
                                message.items = [];
                            message.items.push($root.pyth_lazer_transaction.DynamicValue.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            List.verify = function verify(message) {
                ...
                if (message.items != null && message.hasOwnProperty("items")) {
                    ...
                    for (let i = 0; i < message.items.length; ++i) {
                        let error = $root.pyth_lazer_transaction.DynamicValue.verify(message.items[i]);
                        if (error)
                            return "items." + error;
                    }
                }
            ...
            List.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.DynamicValue.List)
                    return object;
                let message = new $root.pyth_lazer_transaction.DynamicValue.List();
                if (object.items) {
                    if (!Array.isArray(object.items))
                        throw TypeError(".pyth_lazer_transaction.DynamicValue.List.items: array expected");
                    message.items = [];
                    for (let i = 0; i < object.items.length; ++i) {
                        if (typeof object.items[i] !== "object")
                            throw TypeError(".pyth_lazer_transaction.DynamicValue.List.items: object expected");
                        message.items[i] = $root.pyth_lazer_transaction.DynamicValue.fromObject(object.items[i]);
                    }
                }
                return message;
            };
            ...
            List.toObject = function toObject(message, options) {
                ...
                if (message.items && message.items.length) {
                    ...
                    for (let j = 0; j < message.items.length; ++j)
                        object.items[j] = $root.pyth_lazer_transaction.DynamicValue.toObject(message.items[j], options);
                }
                return object;
            };
        ...
        DynamicValue.MapItem = (function() {
            ...
            MapItem.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.MapItem();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            MapItem.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.DynamicValue.MapItem)
                    return object;
                let message = new $root.pyth_lazer_transaction.DynamicValue.MapItem();
                if (object.key != null)
                    message.key = String(object.key);
                if (object.value != null) {
                    if (typeof object.value !== "object")
                        throw TypeError(".pyth_lazer_transaction.DynamicValue.MapItem.value: object expected");
                    message.value = $root.pyth_lazer_transaction.DynamicValue.fromObject(object.value);
                }
                return message;
            };
        ...
        DynamicValue.Map = (function() {
            ...
            Map.encode = function encode(message, writer) {
                ...
                if (message.items != null && message.items.length)
                    for (let i = 0; i < message.items.length; ++i)
                        $root.pyth_lazer_transaction.DynamicValue.MapItem.encode(message.items[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
                return writer;
            };
            ...
            Map.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.Map();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    if (tag === error)
                        break;
                    ...
                    case 1: {
                            if (!(message.items && message.items.length))
                                message.items = [];
                            message.items.push($root.pyth_lazer_transaction.DynamicValue.MapItem.decode(reader, reader.uint32()));
                            break;
                        }
                    default:
                        reader.skipType(tag & 7);
            ...
            Map.verify = function verify(message) {
                ...
                if (message.items != null && message.hasOwnProperty("items")) {
                    if (!Array.isArray(message.items))
                        return "items: array expected";
                    for (let i = 0; i < message.items.length; ++i) {
                        let error = $root.pyth_lazer_transaction.DynamicValue.MapItem.verify(message.items[i]);
                        if (error)
                            return "items." + error;
                    }
                }
            ...
            Map.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.DynamicValue.Map)
                    return object;
                let message = new $root.pyth_lazer_transaction.DynamicValue.Map();
                if (object.items) {
                    if (!Array.isArray(object.items))
                        throw TypeError(".pyth_lazer_transaction.DynamicValue.Map.items: array expected");
                    message.items = [];
                    for (let i = 0; i < object.items.length; ++i) {
                        if (typeof object.items[i] !== "object")
                            throw TypeError(".pyth_lazer_transaction.DynamicValue.Map.items: object expected");
                        message.items[i] = $root.pyth_lazer_transaction.DynamicValue.MapItem.fromObject(object.items[i]);
                    }
                }
                return message;
            };
            ...
            Map.toObject = function toObject(message, options) {
                ...
                if (message.items && message.items.length) {
                    object.items = [];
                    for (let j = 0; j < message.items.length; ++j)
                        object.items[j] = $root.pyth_lazer_transaction.DynamicValue.MapItem.toObject(message.items[j], options);
                }
                return object;
            };
