...
// biome-ignore-all lint/suspicious/noExplicitAny: Legacy code patterns
// biome-ignore-all lint/a11y/noNoninteractiveElementInteractions: Contenteditable table cells require event handlers
              ...
              <table className="w-full table-auto bg-darkGray text-left">
                ...
                <tbody>
                  {table.getRowModel().rows.map((row) => (
                    <tr className="border-t border-beige-300" key={row.id}>
