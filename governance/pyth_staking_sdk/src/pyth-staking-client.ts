// biome-ignore-all lint/suspicious/useAwait: Methods return promises without await for API consistency
  ...
  z.object({
    account: z.object({
      data: z
        ...
        .min(1)
        .transform((data) =>
          // biome-ignore lint/style/noNonNullAssertion: Safe because `min(1)` guarantees that `data` is nonempty
