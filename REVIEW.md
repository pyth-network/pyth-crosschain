...
Check that the code follows the language's best practices. See the standards: [style.md](standards/style.md), [testing.md](standards/testing.md), [services.md](standards/services.md), the [rust/](standards/rust/AGENTS.md) cluster, and the [typescript/](standards/typescript/AGENTS.md) cluster.
