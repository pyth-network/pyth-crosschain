...
export const Theme = {
  ...
  color: {
    background: {
      ...
      "nav-blur":
        "light-dark(rgb(from #fff r g b / 70%), rgb(from #100e23 r g b / 70%))",
    ...
    button: {
      ...
      outline: {
        background: {
          active:
            "light-dark(rgb(from #2d2222 r g b / 10%), rgb(from #f8f9fc r g b / 10%))",
          hover:
            "light-dark(rgb(from #2d2222 r g b / 5%), rgb(from #f8f9fc r g b / 5%))",
        },
        border: "light-dark(#d6d3d1, #474a69)",
    ...
    focusDim:
      "light-dark(rgb(from #6d28d9 r g b / 30%), rgb(from #8b5cf6 r g b / 30%))",
    ...
    states: {
      ...
      info: {
        ...
        "background-opaque":
          "light-dark(rgb(from #c7d2fe r g b / 80%), rgb(from #1e1b4b r g b / 80%))",
