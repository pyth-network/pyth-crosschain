...
/// bumped.
/// Changelog:
/// * v3.1 - prev_attestation_time field added
...
impl PriceAttestation {
    ...
    pub fn from_pyth_price_bytes(
        ...
        prev_attestation_time: UnixTimestamp,
        value: &[u8],
    ) -> Result<Self, ErrBox> {
    ...
    pub fn serialize(&self) -> Vec<u8> {
        ...
        // prev_attestation_time
        buf.extend_from_slice(&prev_attestation_time.to_be_bytes()[..]);
    ...
    pub fn deserialize(mut bytes: impl Read) -> Result<Self, ErrBox> {
        ...
        let mut prev_attestation_time_vec = vec![0u8; mem::size_of::<UnixTimestamp>()];
        bytes.read_exact(prev_attestation_time_vec.as_mut_slice())?;
        let prev_attestation_time =
            UnixTimestamp::from_be_bytes(prev_attestation_time_vec.as_slice().try_into()?);
...
mod tests {
    ...
    fn mock_attestation(prod: Option<[u8; 32]>, price: Option<[u8; 32]>) -> PriceAttestation {
        ...
        PriceAttestation {
            ...
            prev_attestation_time: (0xdeadbeeffadedeafu64) as i64,
        }
    }
