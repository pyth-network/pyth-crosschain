...
#[error]
const ESignerNotTrusted: vector<u8> = b"Recovered public key is not in the trusted signers list";
#[error]
const ESignerExpired: vector<u8> = b"Signer's certificate has expired";
#[error]
const EInvalidUpdateMagic: vector<u8> = b"Invalid magic number in update";
#[error]
const EInvalidPayloadMagic: vector<u8> = b"Invalid magic number in payload";
#[error]
const EInvalidPayloadLength: vector<u8> = b"Payload length doesn't match data";
