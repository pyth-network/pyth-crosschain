...
#[error]
const EMagnitudeTooLarge: vector<u8> = b"Supplied magnitude too large";
#[error]
const ENegativeValue: vector<u8> = b"Supplied I16 is negative";
#[error]
const EPositiveValue: vector<u8> = b"Supplied I16 is positive";
