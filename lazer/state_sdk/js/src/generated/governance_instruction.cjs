...
$root.pyth_lazer_transaction = (function() {
    ...
    pyth_lazer_transaction.GovernanceInstruction = (function() {
        ...
        GovernanceInstruction.decode = function decode(reader, length, error) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceInstruction();
        ...
        GovernanceInstruction.verify = function verify(message) {
            ...
            if (message.directives != null && message.hasOwnProperty("directives")) {
                ...
                for (var i = 0; i < message.directives.length; ++i) {
                    var error = $root.pyth_lazer_transaction.GovernanceDirective.verify(message.directives[i]);
                    if (error)
            ...
            if (message.minExecutionTimestamp != null && message.hasOwnProperty("minExecutionTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.minExecutionTimestamp);
                    if (error)
            ...
            if (message.maxExecutionTimestamp != null && message.hasOwnProperty("maxExecutionTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.maxExecutionTimestamp);
                    if (error)
    ...
    pyth_lazer_transaction.ShardFilter = (function() {
        ...
        ShardFilter.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ShardFilter.verify = function verify(message) {
            ...
            if (message.shardNames != null && message.hasOwnProperty("shardNames")) {
                ...
                properties.filter = 1;
                {
                    var error = $root.pyth_lazer_transaction.ShardFilter.ShardNames.verify(message.shardNames);
                    if (error)
            ...
            if (message.shardGroups != null && message.hasOwnProperty("shardGroups")) {
                ...
                properties.filter = 1;
                {
                    var error = $root.pyth_lazer_transaction.ShardFilter.ShardGroups.verify(message.shardGroups);
                    if (error)
        ...
        ShardFilter.ShardNames = (function() {
            ...
            ShardNames.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter.ShardNames();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
        ...
        ShardFilter.ShardGroups = (function() {
            ...
            ShardGroups.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ShardFilter.ShardGroups();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            ShardGroups.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.ShardFilter.ShardGroups)
                    return object;
                var message = new $root.pyth_lazer_transaction.ShardFilter.ShardGroups();
    ...
    pyth_lazer_transaction.GovernanceDirective = (function() {
        ...
        GovernanceDirective.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceDirective();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        GovernanceDirective.verify = function verify(message) {
            ...
            if (message.shardFilter != null && message.hasOwnProperty("shardFilter")) {
                ...
                {
                    var error = $root.pyth_lazer_transaction.ShardFilter.verify(message.shardFilter);
                    if (error)
            ...
            if (message.createShard != null && message.hasOwnProperty("createShard")) {
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.CreateShard.verify(message.createShard);
                    if (error)
            ...
            if (message.addGovernanceSource != null && message.hasOwnProperty("addGovernanceSource")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.AddGovernanceSource.verify(message.addGovernanceSource);
                    if (error)
            ...
            if (message.updateGovernanceSource != null && message.hasOwnProperty("updateGovernanceSource")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.UpdateGovernanceSource.verify(message.updateGovernanceSource);
                    if (error)
            ...
            if (message.setShardName != null && message.hasOwnProperty("setShardName")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetShardName.verify(message.setShardName);
                    if (error)
            ...
            if (message.setShardGroup != null && message.hasOwnProperty("setShardGroup")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetShardGroup.verify(message.setShardGroup);
                    if (error)
            ...
            if (message.resetLastSequenceNo != null && message.hasOwnProperty("resetLastSequenceNo")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.ResetLastSequenceNo.verify(message.resetLastSequenceNo);
                    if (error)
            ...
            if (message.addPublisher != null && message.hasOwnProperty("addPublisher")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.AddPublisher.verify(message.addPublisher);
                    if (error)
            ...
            if (message.updatePublisher != null && message.hasOwnProperty("updatePublisher")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.UpdatePublisher.verify(message.updatePublisher);
                    if (error)
            ...
            if (message.addFeed != null && message.hasOwnProperty("addFeed")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.AddFeed.verify(message.addFeed);
                    if (error)
            ...
            if (message.updateFeed != null && message.hasOwnProperty("updateFeed")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.UpdateFeed.verify(message.updateFeed);
                    if (error)
    ...
    pyth_lazer_transaction.Permissions = (function() {
        ...
        Permissions.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.Permissions();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.GovernanceSource = (function() {
        ...
        GovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceSource();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        GovernanceSource.verify = function verify(message) {
            ...
            if (message.singleEd25519 != null && message.hasOwnProperty("singleEd25519")) {
                properties.source = 1;
                {
                    var error = $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519.verify(message.singleEd25519);
                    if (error)
            ...
            if (message.wormholeEmitter != null && message.hasOwnProperty("wormholeEmitter")) {
                ...
                properties.source = 1;
                {
                    var error = $root.pyth_lazer_transaction.GovernanceSource.WormholeEmitter.verify(message.wormholeEmitter);
                    if (error)
        ...
        GovernanceSource.SingleEd25519 = (function() {
            ...
            SingleEd25519.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            SingleEd25519.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519)
                    return object;
                var message = new $root.pyth_lazer_transaction.GovernanceSource.SingleEd25519();
        ...
        GovernanceSource.WormholeEmitter = (function() {
            ...
            WormholeEmitter.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.GovernanceSource.WormholeEmitter();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            WormholeEmitter.fromObject = function fromObject(object) {
                if (object instanceof $root.pyth_lazer_transaction.GovernanceSource.WormholeEmitter)
                    return object;
                var message = new $root.pyth_lazer_transaction.GovernanceSource.WormholeEmitter();
    ...
    pyth_lazer_transaction.CreateShard = (function() {
        ...
        CreateShard.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.CreateShard();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.AddGovernanceSource = (function() {
        ...
        AddGovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddGovernanceSource();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        AddGovernanceSource.verify = function verify(message) {
            ...
            if (message.newSource != null && message.hasOwnProperty("newSource")) {
                ...
                {
                    var error = $root.pyth_lazer_transaction.GovernanceSource.verify(message.newSource);
                    if (error)
            ...
            if (message.permissions != null && message.hasOwnProperty("permissions")) {
                ...
                {
                    var error = $root.pyth_lazer_transaction.Permissions.verify(message.permissions);
                    if (error)
    ...
    pyth_lazer_transaction.UpdateGovernanceSource = (function() {
        ...
        UpdateGovernanceSource.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateGovernanceSource();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        UpdateGovernanceSource.verify = function verify(message) {
            ...
            if (message.source != null && message.hasOwnProperty("source")) {
                ...
                {
                    var error = $root.pyth_lazer_transaction.GovernanceSource.verify(message.source);
                    if (error)
                        return "source." + error;
                }
            }
            if (message.setGovernanceSourcePermissions != null && message.hasOwnProperty("setGovernanceSourcePermissions")) {
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetGovernanceSourcePermissions.verify(message.setGovernanceSourcePermissions);
                    if (error)
            ...
            if (message.removeGovernanceSource != null && message.hasOwnProperty("removeGovernanceSource")) {
                ...
                properties.action = 1;
                {
                    var error = $root.google.protobuf.Empty.verify(message.removeGovernanceSource);
                    if (error)
    ...
    pyth_lazer_transaction.SetGovernanceSourcePermissions = (function() {
        ...
        SetGovernanceSourcePermissions.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetGovernanceSourcePermissions();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        SetGovernanceSourcePermissions.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.SetGovernanceSourcePermissions)
                return object;
            var message = new $root.pyth_lazer_transaction.SetGovernanceSourcePermissions();
            if (object.permissions != null) {
                if (typeof object.permissions !== "object")
    ...
    pyth_lazer_transaction.SetShardName = (function() {
        ...
        SetShardName.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetShardName();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.SetShardGroup = (function() {
        ...
        SetShardGroup.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetShardGroup();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.ResetLastSequenceNo = (function() {
        ...
        ResetLastSequenceNo.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ResetLastSequenceNo();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.AddPublisher = (function() {
        ...
        AddPublisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddPublisher();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.UpdatePublisher = (function() {
        ...
        UpdatePublisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdatePublisher();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        UpdatePublisher.verify = function verify(message) {
            ...
            if (message.setPublisherName != null && message.hasOwnProperty("setPublisherName")) {
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetPublisherName.verify(message.setPublisherName);
                    if (error)
            ...
            if (message.addPublisherPublicKeys != null && message.hasOwnProperty("addPublisherPublicKeys")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.AddPublisherPublicKeys.verify(message.addPublisherPublicKeys);
                    if (error)
            ...
            if (message.removePublisherPublicKeys != null && message.hasOwnProperty("removePublisherPublicKeys")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.RemovePublisherPublicKeys.verify(message.removePublisherPublicKeys);
                    if (error)
            ...
            if (message.setPublisherPublicKeys != null && message.hasOwnProperty("setPublisherPublicKeys")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetPublisherPublicKeys.verify(message.setPublisherPublicKeys);
                    if (error)
            ...
            if (message.setPublisherActive != null && message.hasOwnProperty("setPublisherActive")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.SetPublisherActive.verify(message.setPublisherActive);
                    if (error)
            ...
            if (message.removePublisher != null && message.hasOwnProperty("removePublisher")) {
                ...
                properties.action = 1;
                {
                    var error = $root.google.protobuf.Empty.verify(message.removePublisher);
                    if (error)
    ...
    pyth_lazer_transaction.SetPublisherName = (function() {
        ...
        SetPublisherName.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherName();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.AddPublisherPublicKeys = (function() {
        ...
        AddPublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddPublisherPublicKeys();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.RemovePublisherPublicKeys = (function() {
        ...
        RemovePublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.RemovePublisherPublicKeys();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        RemovePublisherPublicKeys.fromObject = function fromObject(object) {
            if (object instanceof $root.pyth_lazer_transaction.RemovePublisherPublicKeys)
                return object;
            var message = new $root.pyth_lazer_transaction.RemovePublisherPublicKeys();
            if (object.publicKeys) {
                if (!Array.isArray(object.publicKeys))
    ...
    pyth_lazer_transaction.SetPublisherPublicKeys = (function() {
        ...
        SetPublisherPublicKeys.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherPublicKeys();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.SetPublisherActive = (function() {
        ...
        SetPublisherActive.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.SetPublisherActive();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    pyth_lazer_transaction.AddFeed = (function() {
        ...
        AddFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.AddFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        AddFeed.verify = function verify(message) {
            ...
            if (message.metadata != null && message.hasOwnProperty("metadata")) {
                ...
                {
                    var error = $root.pyth_lazer_transaction.DynamicValue.Map.verify(message.metadata);
                    if (error)
    ...
    pyth_lazer_transaction.UpdateFeed = (function() {
        ...
        UpdateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        UpdateFeed.verify = function verify(message) {
            ...
            if (message.updateFeedMetadata != null && message.hasOwnProperty("updateFeedMetadata")) {
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.UpdateFeedMetadata.verify(message.updateFeedMetadata);
                    if (error)
            ...
            if (message.activateFeed != null && message.hasOwnProperty("activateFeed")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.ActivateFeed.verify(message.activateFeed);
                    if (error)
            ...
            if (message.deactivateFeed != null && message.hasOwnProperty("deactivateFeed")) {
                ...
                properties.action = 1;
                {
                    var error = $root.pyth_lazer_transaction.DeactivateFeed.verify(message.deactivateFeed);
                    if (error)
    ...
    pyth_lazer_transaction.UpdateFeedMetadata = (function() {
        ...
        UpdateFeedMetadata.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.UpdateFeedMetadata();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        UpdateFeedMetadata.verify = function verify(message) {
            ...
            if (message.value != null && message.hasOwnProperty("value")) {
                properties._value = 1;
                {
                    var error = $root.pyth_lazer_transaction.DynamicValue.verify(message.value);
                    if (error)
                        return "value." + error;
                }
            }
    ...
    pyth_lazer_transaction.ActivateFeed = (function() {
        ...
        ActivateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.ActivateFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        ActivateFeed.verify = function verify(message) {
            ...
            if (message.activationTimestamp != null && message.hasOwnProperty("activationTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.activationTimestamp);
                    if (error)
    ...
    pyth_lazer_transaction.DeactivateFeed = (function() {
        ...
        DeactivateFeed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DeactivateFeed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        DeactivateFeed.verify = function verify(message) {
            ...
            if (message.deactivationTimestamp != null && message.hasOwnProperty("deactivationTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.deactivationTimestamp);
                    if (error)
    ...
    pyth_lazer_transaction.DynamicValue = (function() {
        ...
        DynamicValue.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        DynamicValue.verify = function verify(message) {
            ...
            if (message.list != null && message.hasOwnProperty("list")) {
                ...
                properties.value = 1;
                {
                    var error = $root.pyth_lazer_transaction.DynamicValue.List.verify(message.list);
                    if (error)
                        return "list." + error;
                }
            }
            if (message.map != null && message.hasOwnProperty("map")) {
                ...
                properties.value = 1;
                {
                    var error = $root.pyth_lazer_transaction.DynamicValue.Map.verify(message.map);
                    if (error)
                        return "map." + error;
                }
            }
        ...
        DynamicValue.List = (function() {
            ...
            List.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.List();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            List.verify = function verify(message) {
                ...
                if (message.items != null && message.hasOwnProperty("items")) {
                    ...
                    for (var i = 0; i < message.items.length; ++i) {
                        var error = $root.pyth_lazer_transaction.DynamicValue.verify(message.items[i]);
                        if (error)
                            return "items." + error;
                    }
                }
        ...
        DynamicValue.MapItem = (function() {
            ...
            MapItem.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.MapItem();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
        ...
        DynamicValue.Map = (function() {
            ...
            Map.decode = function decode(reader, length, error) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.pyth_lazer_transaction.DynamicValue.Map();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    if (tag === error)
                        break;
            ...
            Map.verify = function verify(message) {
                ...
                if (message.items != null && message.hasOwnProperty("items")) {
                    if (!Array.isArray(message.items))
                        return "items: array expected";
                    for (var i = 0; i < message.items.length; ++i) {
                        var error = $root.pyth_lazer_transaction.DynamicValue.MapItem.verify(message.items[i]);
                        if (error)
                            return "items." + error;
                    }
                }
