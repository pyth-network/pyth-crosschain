...
export const lazer = $root.lazer = (() => {
    ...
    lazer.State = (function() {
        ...
        State.encode = function encode(message, writer) {
            ...
            if (message.lastSequenceNo != null && Object.hasOwnProperty.call(message, "lastSequenceNo"))
                writer.uint32(/* id 2, wireType 0 =*/16).uint64(message.lastSequenceNo);
            if (message.lastTimestamp != null && Object.hasOwnProperty.call(message, "lastTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.lastTimestamp, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            ...
            if (message.minRate != null && Object.hasOwnProperty.call(message, "minRate"))
                $root.google.protobuf.Duration.encode(message.minRate, writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
            if (message.feeds != null && message.feeds.length)
                for (let i = 0; i < message.feeds.length; ++i)
                    $root.lazer.Feed.encode(message.feeds[i], writer.uint32(/* id 7, wireType 2 =*/58).fork()).ldelim();
            if (message.publishers != null && message.publishers.length)
                for (let i = 0; i < message.publishers.length; ++i)
                    $root.lazer.Publisher.encode(message.publishers[i], writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            return writer;
        };
        ...
        State.decode = function decode(reader, length, error) {
            ...
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.State();
            while (reader.pos < end) {
                ...
                case 3: {
                        message.lastTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                ...
                case 7: {
                        if (!(message.feeds && message.feeds.length))
                            message.feeds = [];
                        message.feeds.push($root.lazer.Feed.decode(reader, reader.uint32()));
                        break;
                    }
                case 8: {
                        if (!(message.publishers && message.publishers.length))
                            message.publishers = [];
                        message.publishers.push($root.lazer.Publisher.decode(reader, reader.uint32()));
                        break;
                    }
                default:
        ...
        State.verify = function verify(message) {
            ...
            if (message.lastTimestamp != null && message.hasOwnProperty("lastTimestamp")) {
                ...
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.lastTimestamp);
                    if (error)
            ...
            if (message.feeds != null && message.hasOwnProperty("feeds")) {
                ...
                for (let i = 0; i < message.feeds.length; ++i) {
                    let error = $root.lazer.Feed.verify(message.feeds[i]);
                    if (error)
                        return "feeds." + error;
                }
            }
            if (message.publishers != null && message.hasOwnProperty("publishers")) {
                ...
                for (let i = 0; i < message.publishers.length; ++i) {
                    let error = $root.lazer.Publisher.verify(message.publishers[i]);
                    if (error)
        ...
        State.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.State)
                return object;
            let message = new $root.lazer.State();
            ...
            if (object.lastTimestamp != null) {
                ...
                message.lastTimestamp = $root.google.protobuf.Timestamp.fromObject(object.lastTimestamp);
            }
            ...
            if (object.feeds) {
                ...
                message.feeds = [];
                for (let i = 0; i < object.feeds.length; ++i) {
            ...
            if (object.publishers) {
                ...
                message.publishers = [];
                for (let i = 0; i < object.publishers.length; ++i) {
                    if (typeof object.publishers[i] !== "object")
                        throw TypeError(".lazer.State.publishers: object expected");
                    message.publishers[i] = $root.lazer.Publisher.fromObject(object.publishers[i]);
                }
            }
            return message;
        };
        ...
        State.toObject = function toObject(message, options) {
            ...
            if (message.lastTimestamp != null && message.hasOwnProperty("lastTimestamp")) {
                object.lastTimestamp = $root.google.protobuf.Timestamp.toObject(message.lastTimestamp, options);
                if (options.oneofs)
                    object._lastTimestamp = "lastTimestamp";
            }
            if (message.shardName != null && message.hasOwnProperty("shardName")) {
            ...
            if (message.feeds && message.feeds.length) {
                object.feeds = [];
                for (let j = 0; j < message.feeds.length; ++j)
                    object.feeds[j] = $root.lazer.Feed.toObject(message.feeds[j], options);
            }
            if (message.publishers && message.publishers.length) {
                object.publishers = [];
                for (let j = 0; j < message.publishers.length; ++j)
                    object.publishers[j] = $root.lazer.Publisher.toObject(message.publishers[j], options);
            }
            return object;
        };
    ...
    lazer.Publisher = (function() {
        ...
        Publisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.Publisher();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        Publisher.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.Publisher)
                return object;
            let message = new $root.lazer.Publisher();
    ...
    lazer.FeedMetadata = (function() {
        ...
        FeedMetadata.encode = function encode(message, writer) {
            ...
            if (message.fundingRateInterval != null && Object.hasOwnProperty.call(message, "fundingRateInterval"))
                $root.google.protobuf.Duration.encode(message.fundingRateInterval, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
            if (message.minPublishers != null && Object.hasOwnProperty.call(message, "minPublishers"))
                writer.uint32(/* id 9, wireType 0 =*/72).uint32(message.minPublishers);
            if (message.minRate != null && Object.hasOwnProperty.call(message, "minRate"))
                $root.google.protobuf.Duration.encode(message.minRate, writer.uint32(/* id 10, wireType 2 =*/82).fork()).ldelim();
            if (message.expiryTime != null && Object.hasOwnProperty.call(message, "expiryTime"))
                $root.google.protobuf.Duration.encode(message.expiryTime, writer.uint32(/* id 11, wireType 2 =*/90).fork()).ldelim();
            ...
            if (message.hermesId != null && Object.hasOwnProperty.call(message, "hermesId"))
            ...
            if (message.marketSchedule != null && Object.hasOwnProperty.call(message, "marketSchedule"))
                writer.uint32(/* id 15, wireType 2 =*/122).string(message.marketSchedule);
            return writer;
        };
        ...
        FeedMetadata.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedMetadata();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 8: {
                        message.fundingRateInterval = $root.google.protobuf.Duration.decode(reader, reader.uint32());
                        break;
                    }
                case 9: {
                ...
                case 11: {
                        message.expiryTime = $root.google.protobuf.Duration.decode(reader, reader.uint32());
                        break;
                    }
                case 12: {
        ...
        FeedMetadata.verify = function verify(message) {
            ...
            if (message.cmcId != null && message.hasOwnProperty("cmcId")) {
                properties._cmcId = 1;
                if (!$util.isInteger(message.cmcId))
                    return "cmcId: integer expected";
            }
            if (message.fundingRateInterval != null && message.hasOwnProperty("fundingRateInterval")) {
                properties._fundingRateInterval = 1;
                {
                    let error = $root.google.protobuf.Duration.verify(message.fundingRateInterval);
                    if (error)
                        return "fundingRateInterval." + error;
                }
            }
            if (message.minPublishers != null && message.hasOwnProperty("minPublishers")) {
            ...
            if (message.expiryTime != null && message.hasOwnProperty("expiryTime")) {
                ...
                {
                    let error = $root.google.protobuf.Duration.verify(message.expiryTime);
                    if (error)
            ...
            if (message.marketSchedule != null && message.hasOwnProperty("marketSchedule")) {
        ...
        FeedMetadata.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.FeedMetadata)
                return object;
            let message = new $root.lazer.FeedMetadata();
            ...
            if (object.cmcId != null)
                message.cmcId = object.cmcId >>> 0;
            if (object.fundingRateInterval != null) {
                if (typeof object.fundingRateInterval !== "object")
                    throw TypeError(".lazer.FeedMetadata.fundingRateInterval: object expected");
                message.fundingRateInterval = $root.google.protobuf.Duration.fromObject(object.fundingRateInterval);
            }
            ...
            if (object.expiryTime != null) {
                ...
                message.expiryTime = $root.google.protobuf.Duration.fromObject(object.expiryTime);
            }
            if (object.isActivated != null)
                message.isActivated = Boolean(object.isActivated);
            if (object.hermesId != null)
                message.hermesId = String(object.hermesId);
        ...
        FeedMetadata.toObject = function toObject(message, options) {
            ...
            if (message.assetType != null && message.hasOwnProperty("assetType")) {
                object.assetType = options.enums === String ? $root.lazer.AssetType[message.assetType] === undefined ? message.assetType : $root.lazer.AssetType[message.assetType] : message.assetType;
                if (options.oneofs)
                    object._assetType = "assetType";
            }
            if (message.exponent != null && message.hasOwnProperty("exponent")) {
                object.exponent = message.exponent;
                if (options.oneofs)
                    object._exponent = "exponent";
            }
            if (message.cmcId != null && message.hasOwnProperty("cmcId")) {
            ...
            if (message.fundingRateInterval != null && message.hasOwnProperty("fundingRateInterval")) {
                object.fundingRateInterval = $root.google.protobuf.Duration.toObject(message.fundingRateInterval, options);
                if (options.oneofs)
                    object._fundingRateInterval = "fundingRateInterval";
            }
            if (message.minPublishers != null && message.hasOwnProperty("minPublishers")) {
                object.minPublishers = message.minPublishers;
                if (options.oneofs)
                    object._minPublishers = "minPublishers";
            }
            if (message.minRate != null && message.hasOwnProperty("minRate")) {
                object.minRate = $root.google.protobuf.Duration.toObject(message.minRate, options);
                if (options.oneofs)
            ...
            if (message.expiryTime != null && message.hasOwnProperty("expiryTime")) {
                object.expiryTime = $root.google.protobuf.Duration.toObject(message.expiryTime, options);
                if (options.oneofs)
                    object._expiryTime = "expiryTime";
            }
            if (message.isActivated != null && message.hasOwnProperty("isActivated")) {
                object.isActivated = message.isActivated;
                if (options.oneofs)
                    object._isActivated = "isActivated";
            }
            if (message.hermesId != null && message.hasOwnProperty("hermesId")) {
                object.hermesId = message.hermesId;
                if (options.oneofs)
                    object._hermesId = "hermesId";
            }
            if (message.quoteCurrency != null && message.hasOwnProperty("quoteCurrency")) {
                object.quoteCurrency = message.quoteCurrency;
                if (options.oneofs)
                    object._quoteCurrency = "quoteCurrency";
            }
            if (message.marketSchedule != null && message.hasOwnProperty("marketSchedule")) {
                object.marketSchedule = message.marketSchedule;
                if (options.oneofs)
                    object._marketSchedule = "marketSchedule";
            }
            return object;
        };
    ...
    lazer.Feed = (function() {
        ...
        Feed.encode = function encode(message, writer) {
            ...
            if (message.metadata != null && Object.hasOwnProperty.call(message, "metadata"))
                $root.lazer.FeedMetadata.encode(message.metadata, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.pendingActivation != null && Object.hasOwnProperty.call(message, "pendingActivation"))
                $root.google.protobuf.Timestamp.encode(message.pendingActivation, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.pendingDeactivation != null && Object.hasOwnProperty.call(message, "pendingDeactivation"))
                $root.google.protobuf.Timestamp.encode(message.pendingDeactivation, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.perPublisher != null && message.perPublisher.length)
                for (let i = 0; i < message.perPublisher.length; ++i)
                    $root.lazer.FeedPublisherState.encode(message.perPublisher[i], writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
        ...
        Feed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.Feed();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.metadata = $root.lazer.FeedMetadata.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.pendingActivation = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.pendingDeactivation = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        if (!(message.perPublisher && message.perPublisher.length))
                            message.perPublisher = [];
                        message.perPublisher.push($root.lazer.FeedPublisherState.decode(reader, reader.uint32()));
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        Feed.verify = function verify(message) {
            ...
            if (message.metadata != null && message.hasOwnProperty("metadata")) {
                ...
                {
                    let error = $root.lazer.FeedMetadata.verify(message.metadata);
                    if (error)
                        return "metadata." + error;
                }
            }
            if (message.pendingActivation != null && message.hasOwnProperty("pendingActivation")) {
                properties._pendingActivation = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.pendingActivation);
                    if (error)
                        return "pendingActivation." + error;
                }
            }
            if (message.pendingDeactivation != null && message.hasOwnProperty("pendingDeactivation")) {
                properties._pendingDeactivation = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.pendingDeactivation);
                    if (error)
                        return "pendingDeactivation." + error;
                }
            }
            if (message.perPublisher != null && message.hasOwnProperty("perPublisher")) {
                if (!Array.isArray(message.perPublisher))
                    return "perPublisher: array expected";
                for (let i = 0; i < message.perPublisher.length; ++i) {
                    let error = $root.lazer.FeedPublisherState.verify(message.perPublisher[i]);
                    if (error)
                        return "perPublisher." + error;
                }
            }
            return null;
        };
        ...
        Feed.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.Feed)
                return object;
            let message = new $root.lazer.Feed();
            ...
            if (object.pendingActivation != null) {
                ...
                message.pendingActivation = $root.google.protobuf.Timestamp.fromObject(object.pendingActivation);
            }
            if (object.pendingDeactivation != null) {
                ...
                message.pendingDeactivation = $root.google.protobuf.Timestamp.fromObject(object.pendingDeactivation);
            }
            if (object.perPublisher) {
                if (!Array.isArray(object.perPublisher))
                    throw TypeError(".lazer.Feed.perPublisher: array expected");
                message.perPublisher = [];
                for (let i = 0; i < object.perPublisher.length; ++i) {
                    if (typeof object.perPublisher[i] !== "object")
                        throw TypeError(".lazer.Feed.perPublisher: object expected");
                    message.perPublisher[i] = $root.lazer.FeedPublisherState.fromObject(object.perPublisher[i]);
                }
            }
            return message;
        };
        ...
        Feed.toObject = function toObject(message, options) {
            ...
            if (options.arrays || options.defaults)
                object.perPublisher = [];
            if (message.metadata != null && message.hasOwnProperty("metadata")) {
                object.metadata = $root.lazer.FeedMetadata.toObject(message.metadata, options);
                if (options.oneofs)
                    object._metadata = "metadata";
            }
            if (message.pendingActivation != null && message.hasOwnProperty("pendingActivation")) {
                object.pendingActivation = $root.google.protobuf.Timestamp.toObject(message.pendingActivation, options);
                if (options.oneofs)
                    object._pendingActivation = "pendingActivation";
            }
            if (message.pendingDeactivation != null && message.hasOwnProperty("pendingDeactivation")) {
                object.pendingDeactivation = $root.google.protobuf.Timestamp.toObject(message.pendingDeactivation, options);
                if (options.oneofs)
                    object._pendingDeactivation = "pendingDeactivation";
            }
            if (message.perPublisher && message.perPublisher.length) {
                object.perPublisher = [];
                for (let j = 0; j < message.perPublisher.length; ++j)
                    object.perPublisher[j] = $root.lazer.FeedPublisherState.toObject(message.perPublisher[j], options);
            }
            return object;
        };
    ...
    lazer.FeedPublisherState = (function() {
         ...
         * @instance
         */
        Object.defineProperty(FeedPublisherState.prototype, "_lastUpdateTimestamp", {
         ...
         * @instance
         */
        Object.defineProperty(FeedPublisherState.prototype, "_lastPublisherTimestamp", {
        ...
        FeedPublisherState.encode = function encode(message, writer) {
            ...
            if (message.lastUpdateTimestamp != null && Object.hasOwnProperty.call(message, "lastUpdateTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.lastUpdateTimestamp, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            if (message.lastPublisherTimestamp != null && Object.hasOwnProperty.call(message, "lastPublisherTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.lastPublisherTimestamp, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
            if (message.lastFeedData != null && Object.hasOwnProperty.call(message, "lastFeedData"))
                $root.lazer.FeedData.encode(message.lastFeedData, writer.uint32(/* id 4, wireType 2 =*/34).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        FeedPublisherState.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        FeedPublisherState.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedPublisherState();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                ...
                case 2: {
                        message.lastUpdateTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
                        message.lastPublisherTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 4: {
                        message.lastFeedData = $root.lazer.FeedData.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        FeedPublisherState.verify = function verify(message) {
            ...
            if (message.lastUpdateTimestamp != null && message.hasOwnProperty("lastUpdateTimestamp")) {
                ...
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.lastUpdateTimestamp);
                    if (error)
                        return "lastUpdateTimestamp." + error;
                }
            }
            if (message.lastPublisherTimestamp != null && message.hasOwnProperty("lastPublisherTimestamp")) {
                properties._lastPublisherTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.lastPublisherTimestamp);
                    if (error)
                        return "lastPublisherTimestamp." + error;
                }
            }
            if (message.lastFeedData != null && message.hasOwnProperty("lastFeedData")) {
                properties._lastFeedData = 1;
                {
                    let error = $root.lazer.FeedData.verify(message.lastFeedData);
                    if (error)
                        return "lastFeedData." + error;
                }
            }
            return null;
        };
        ...
        FeedPublisherState.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.FeedPublisherState)
                return object;
            let message = new $root.lazer.FeedPublisherState();
            if (object.publisherId != null)
                message.publisherId = object.publisherId >>> 0;
            if (object.lastUpdateTimestamp != null) {
                if (typeof object.lastUpdateTimestamp !== "object")
                    throw TypeError(".lazer.FeedPublisherState.lastUpdateTimestamp: object expected");
                message.lastUpdateTimestamp = $root.google.protobuf.Timestamp.fromObject(object.lastUpdateTimestamp);
            }
            if (object.lastPublisherTimestamp != null) {
                if (typeof object.lastPublisherTimestamp !== "object")
                    throw TypeError(".lazer.FeedPublisherState.lastPublisherTimestamp: object expected");
                message.lastPublisherTimestamp = $root.google.protobuf.Timestamp.fromObject(object.lastPublisherTimestamp);
            }
            if (object.lastFeedData != null) {
                if (typeof object.lastFeedData !== "object")
                    throw TypeError(".lazer.FeedPublisherState.lastFeedData: object expected");
                message.lastFeedData = $root.lazer.FeedData.fromObject(object.lastFeedData);
            }
            return message;
        };
        ...
        FeedPublisherState.toObject = function toObject(message, options) {
            ...
            if (message.lastUpdateTimestamp != null && message.hasOwnProperty("lastUpdateTimestamp")) {
                object.lastUpdateTimestamp = $root.google.protobuf.Timestamp.toObject(message.lastUpdateTimestamp, options);
                if (options.oneofs)
                    object._lastUpdateTimestamp = "lastUpdateTimestamp";
            }
            if (message.lastPublisherTimestamp != null && message.hasOwnProperty("lastPublisherTimestamp")) {
                object.lastPublisherTimestamp = $root.google.protobuf.Timestamp.toObject(message.lastPublisherTimestamp, options);
                if (options.oneofs)
                    object._lastPublisherTimestamp = "lastPublisherTimestamp";
            }
            if (message.lastFeedData != null && message.hasOwnProperty("lastFeedData")) {
                object.lastFeedData = $root.lazer.FeedData.toObject(message.lastFeedData, options);
                if (options.oneofs)
                    object._lastFeedData = "lastFeedData";
            }
            return object;
        };
    ...
    lazer.FeedData = (function() {
        ...
        FeedData.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.sourceTimestamp != null && Object.hasOwnProperty.call(message, "sourceTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.sourceTimestamp, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            if (message.publisherTimestamp != null && Object.hasOwnProperty.call(message, "publisherTimestamp"))
                $root.google.protobuf.Timestamp.encode(message.publisherTimestamp, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            ...
            if (message.fundingRate != null && Object.hasOwnProperty.call(message, "fundingRate"))
        ...
        FeedData.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            let end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedData();
            while (reader.pos < end) {
                let tag = reader.uint32();
                if (tag === error)
                    break;
                switch (tag >>> 3) {
                case 1: {
                        message.sourceTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 2: {
                        message.publisherTimestamp = $root.google.protobuf.Timestamp.decode(reader, reader.uint32());
                        break;
                    }
                case 3: {
        ...
        FeedData.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            let properties = {};
            if (message.sourceTimestamp != null && message.hasOwnProperty("sourceTimestamp")) {
                properties._sourceTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.sourceTimestamp);
                    if (error)
                        return "sourceTimestamp." + error;
                }
            }
            if (message.publisherTimestamp != null && message.hasOwnProperty("publisherTimestamp")) {
                properties._publisherTimestamp = 1;
                {
                    let error = $root.google.protobuf.Timestamp.verify(message.publisherTimestamp);
                    if (error)
                        return "publisherTimestamp." + error;
                }
            }
            ...
            if (message.fundingRate != null && message.hasOwnProperty("fundingRate")) {
                properties._fundingRate = 1;
                if (!$util.isInteger(message.fundingRate) && !(message.fundingRate && $util.isInteger(message.fundingRate.low) && $util.isInteger(message.fundingRate.high)))
        ...
        FeedData.fromObject = function fromObject(object) {
            if (object instanceof $root.lazer.FeedData)
                return object;
            let message = new $root.lazer.FeedData();
            if (object.sourceTimestamp != null) {
                ...
                message.sourceTimestamp = $root.google.protobuf.Timestamp.fromObject(object.sourceTimestamp);
            }
            if (object.publisherTimestamp != null) {
                if (typeof object.publisherTimestamp !== "object")
                    throw TypeError(".lazer.FeedData.publisherTimestamp: object expected");
                message.publisherTimestamp = $root.google.protobuf.Timestamp.fromObject(object.publisherTimestamp);
            }
            ...
            if (object.fundingRate != null)
                if ($util.Long)
                    (message.fundingRate = $util.Long.fromValue(object.fundingRate)).unsigned = false;
                    ...
                    message.fundingRate = new $util.LongBits(object.fundingRate.low >>> 0, object.fundingRate.high >>> 0).toNumber();
            return message;
        };
        ...
        FeedData.toObject = function toObject(message, options) {
            ...
            let object = {};
            if (message.sourceTimestamp != null && message.hasOwnProperty("sourceTimestamp")) {
                object.sourceTimestamp = $root.google.protobuf.Timestamp.toObject(message.sourceTimestamp, options);
                if (options.oneofs)
                    object._sourceTimestamp = "sourceTimestamp";
            }
            if (message.publisherTimestamp != null && message.hasOwnProperty("publisherTimestamp")) {
                object.publisherTimestamp = $root.google.protobuf.Timestamp.toObject(message.publisherTimestamp, options);
                if (options.oneofs)
                    object._publisherTimestamp = "publisherTimestamp";
            }
            if (message.price != null && message.hasOwnProperty("price")) {
            ...
            if (message.fundingRate != null && message.hasOwnProperty("fundingRate")) {
                if (typeof message.fundingRate === "number")
                    object.fundingRate = options.longs === String ? String(message.fundingRate) : message.fundingRate;
                else
                    object.fundingRate = options.longs === String ? $util.Long.prototype.toString.call(message.fundingRate) : options.longs === Number ? new $util.LongBits(message.fundingRate.low >>> 0, message.fundingRate.high >>> 0).toNumber() : message.fundingRate;
                if (options.oneofs)
                    object._fundingRate = "fundingRate";
            }
            return object;
        };
