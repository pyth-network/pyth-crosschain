  ...
  pyth_lazer_transaction.GovernanceInstruction = (function () {
    ...
    GovernanceInstruction.verify = function verify(message) {
      ...
      if (message.directives != null && message.hasOwnProperty("directives")) {
        ...
        for (let i = 0; i < message.directives.length; ++i) {
          let error = $root.pyth_lazer_transaction.GovernanceDirective.verify(
            message.directives[i],
          );
  ...
  pyth_lazer_transaction.GovernanceDirective = (function () {
    ...
    GovernanceDirective.verify = function verify(message) {
      ...
      if (
        ...
        {
          let error = $root.pyth_lazer_transaction.ShardFilter.verify(
            message.shardFilter,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.CreateShard.verify(
            message.createShard,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.AddGovernanceSource.verify(
            message.addGovernanceSource,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.SetShardName.verify(
            message.setShardName,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.SetShardGroup.verify(
            message.setShardGroup,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.ResetLastSequenceNo.verify(
            message.resetLastSequenceNo,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.AddPublisher.verify(
            message.addPublisher,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.UpdatePublisher.verify(
            message.updatePublisher,
          );
      ...
      if (message.addFeed != null && message.hasOwnProperty("addFeed")) {
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.AddFeed.verify(
            message.addFeed,
          );
      ...
      if (message.updateFeed != null && message.hasOwnProperty("updateFeed")) {
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.UpdateFeed.verify(
            message.updateFeed,
          );
  ...
  pyth_lazer_transaction.AddGovernanceSource = (function () {
    ...
    AddGovernanceSource.verify = function verify(message) {
      ...
      if (message.newSource != null && message.hasOwnProperty("newSource")) {
        ...
        {
          let error = $root.pyth_lazer_transaction.GovernanceSource.verify(
            message.newSource,
          );
      ...
      if (
        ...
        {
          let error = $root.pyth_lazer_transaction.Permissions.verify(
            message.permissions,
          );
  ...
  pyth_lazer_transaction.UpdateGovernanceSource = (function () {
    ...
    UpdateGovernanceSource.verify = function verify(message) {
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.google.protobuf.Empty.verify(
            message.removeGovernanceSource,
          );
  ...
  pyth_lazer_transaction.UpdatePublisher = (function () {
    ...
    UpdatePublisher.verify = function verify(message) {
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.SetPublisherName.verify(
            message.setPublisherName,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.SetPublisherActive.verify(
            message.setPublisherActive,
          );
  ...
  pyth_lazer_transaction.AddFeed = (function () {
    ...
    AddFeed.verify = function verify(message) {
      ...
      if (message.metadata != null && message.hasOwnProperty("metadata")) {
        ...
        {
          let error = $root.pyth_lazer_transaction.DynamicValue.Map.verify(
            message.metadata,
          );
  ...
  pyth_lazer_transaction.UpdateFeed = (function () {
    ...
    UpdateFeed.verify = function verify(message) {
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.UpdateFeedMetadata.verify(
            message.updateFeedMetadata,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.ActivateFeed.verify(
            message.activateFeed,
          );
      ...
      if (
        ...
        properties.action = 1;
        {
          let error = $root.pyth_lazer_transaction.DeactivateFeed.verify(
            message.deactivateFeed,
          );
  ...
  pyth_lazer_transaction.UpdateFeedMetadata = (function () {
    ...
    UpdateFeedMetadata.verify = function verify(message) {
      ...
      if (message.value != null && message.hasOwnProperty("value")) {
        properties._value = 1;
        {
          let error = $root.pyth_lazer_transaction.DynamicValue.verify(
            message.value,
          );
  ...
  pyth_lazer_transaction.DynamicValue = (function () {
    ...
    DynamicValue.verify = function verify(message) {
      ...
      if (
        ...
        properties.value = 1;
        {
          let error = $root.google.protobuf.Duration.verify(
            message.durationValue,
          );
      ...
      if (message.list != null && message.hasOwnProperty("list")) {
        ...
        properties.value = 1;
        {
          let error = $root.pyth_lazer_transaction.DynamicValue.List.verify(
            message.list,
          );
