...
$root.lazer = (function() {
    ...
    lazer.State = (function() {
        ...
        State.decode = function decode(reader, length, error) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.State();
        ...
        State.verify = function verify(message) {
            ...
            if (message.lastTimestamp != null && message.hasOwnProperty("lastTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.lastTimestamp);
                    if (error)
    ...
    lazer.Publisher = (function() {
        ...
        Publisher.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.Publisher();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
    ...
    lazer.FeedMetadata = (function() {
        ...
        FeedMetadata.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedMetadata();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        FeedMetadata.verify = function verify(message) {
            ...
            if (message.fundingRateInterval != null && message.hasOwnProperty("fundingRateInterval")) {
                ...
                {
                    var error = $root.google.protobuf.Duration.verify(message.fundingRateInterval);
                    if (error)
    ...
    lazer.Feed = (function() {
        ...
        Feed.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.Feed();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        Feed.verify = function verify(message) {
            ...
            if (message.pendingActivation != null && message.hasOwnProperty("pendingActivation")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.pendingActivation);
                    if (error)
            ...
            if (message.pendingDeactivation != null && message.hasOwnProperty("pendingDeactivation")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.pendingDeactivation);
                    if (error)
            ...
            if (message.perPublisher != null && message.hasOwnProperty("perPublisher")) {
                ...
                for (var i = 0; i < message.perPublisher.length; ++i) {
                    var error = $root.lazer.FeedPublisherState.verify(message.perPublisher[i]);
                    if (error)
    ...
    lazer.FeedPublisherState = (function() {
        ...
        FeedPublisherState.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedPublisherState();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        FeedPublisherState.verify = function verify(message) {
            ...
            if (message.lastUpdateTimestamp != null && message.hasOwnProperty("lastUpdateTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.lastUpdateTimestamp);
                    if (error)
            ...
            if (message.lastPublisherTimestamp != null && message.hasOwnProperty("lastPublisherTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.lastPublisherTimestamp);
                    if (error)
    ...
    lazer.FeedData = (function() {
        ...
        FeedData.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.lazer.FeedData();
            while (reader.pos < end) {
                var tag = reader.uint32();
                if (tag === error)
                    break;
        ...
        FeedData.verify = function verify(message) {
            ...
            if (message.sourceTimestamp != null && message.hasOwnProperty("sourceTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.sourceTimestamp);
                    if (error)
            ...
            if (message.publisherTimestamp != null && message.hasOwnProperty("publisherTimestamp")) {
                ...
                {
                    var error = $root.google.protobuf.Timestamp.verify(message.publisherTimestamp);
                    if (error)
