...
export namespace lazer {
  ...
  class FeedPublisherState implements IFeedPublisherState {
    ...
    public static create(
      properties?: lazer.IFeedPublisherState,
    ): lazer.FeedPublisherState;
     ...
     */
    public static encode(
      message: lazer.IFeedPublisherState,
      writer?: $protobuf.Writer,
    ): $protobuf.Writer;
     ...
     */
    public static toObject(
      message: lazer.FeedPublisherState,
      options?: $protobuf.IConversionOptions,
    ): { [k: string]: any };
