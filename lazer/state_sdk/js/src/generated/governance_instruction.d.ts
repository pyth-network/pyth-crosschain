...
export namespace pyth_lazer_transaction {
  ...
  namespace GovernanceSource {
    ...
    class WormholeEmitter implements IWormholeEmitter {
       ...
       */
      constructor(
        properties?: pyth_lazer_transaction.GovernanceSource.IWormholeEmitter,
      );
       ...
       */
      public static encode(
        message: pyth_lazer_transaction.GovernanceSource.IWormholeEmitter,
        writer?: $protobuf.Writer,
      ): $protobuf.Writer;
       ...
       */
      public static toObject(
        message: pyth_lazer_transaction.GovernanceSource.WormholeEmitter,
        options?: $protobuf.IConversionOptions,
      ): { [k: string]: any };
