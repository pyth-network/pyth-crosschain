...
interface PythContractAbiInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'constructor', values: [Vec<DataSourceInput>, DataSourceInput, DataSourceInput, BigNumberish, BigNumberish, Vec<string>, BigNumberish, BigNumberish]): Uint8Array;
  encodeFunctionData(functionFragment: 'chain_id', values: []): Uint8Array;
  encodeFunctionData(functionFragment: 'is_valid_data_source', values: [DataSourceInput]): Uint8Array;
  encodeFunctionData(functionFragment: 'last_executed_governance_sequence', values: []): Uint8Array;
  ...
  encodeFunctionData(functionFragment: 'execute_governance_instruction', values: [Bytes]): Uint8Array;
  encodeFunctionData(functionFragment: 'governance_data_source', values: []): Uint8Array;
  ...
  decodeFunctionData(functionFragment: 'chain_id', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'is_valid_data_source', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'last_executed_governance_sequence', data: BytesLike): DecodedValue;
  ...
  decodeFunctionData(functionFragment: 'execute_governance_instruction', data: BytesLike): DecodedValue;
  decodeFunctionData(functionFragment: 'governance_data_source', data: BytesLike): DecodedValue;
}
