          ...
          },
          {
            ...
            description: (
              <p>
                ...
                vested.) Unlocked & Unstaked tokens are therefore tokens you can
          ...
          },
          {
            ...
            description: (
              <p>
                ...
                Staking. Available Rewards can be claimed at any time. Claimed
                rewards will move to the Unlocked & Unstaked balance.
              </p>
            ),
          },
        ],
          ...
          },
          {
            ...
            description: (
              <p>
                ...
                Staked tokens contribute to oracle integrity by enhancing
                potential publisher rewards and incentivizing high quality data
                contributions. Accordingly, staked tokens are subject to both
                programmatic rewards and slashing penalties.
              </p>
            ),
            image: stakedTokens,
          },
        ...
        description: (
          <>
            ...
            <p>
              ...
              added to the Available Rewards balance. When you claim your
              rewards, the tokens move to Unlocked & Unstaked, where you can
              choose to restake or withdraw them to your wallet.
            </p>
            ...
            description: (
              <>
                <p>
                  ...
                  Available Rewards at the top of the dashboard. Click Claim to
                  move these rewards to Unlocked & Unstaked.
                </p>
                <p>
              ...
              answer: (
                <>
                  ...
                  <p>
                    ...
                    about how rewards are calculated in the documentation.
                  </p>
                </>
              ),
            },
