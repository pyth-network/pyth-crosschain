    ...
    <div className={styles.container}>
      ...
      {showProCompatibleStatus && (
        <p className={styles.introText}>
          ...
          <strong>Available</strong> are already served by the upgraded Hermes. Not{" "}
          all <strong>Coming soon</strong> feeds will be migrated; please reach
          out if you rely on a specific feed.
        </p>
      )}
