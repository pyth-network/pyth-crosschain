      ...
      <main className={styles.mainContent}>
        <div className={styles.contentWrapper}>
          ...
          <p className={styles.description}>
            Pyth Network is the leading oracle protocol that connects the owners
            of market data to applications on multiple blockchains.{" "}
            <Link
              href="https://insights.pyth.network/publishers"
              target="_blank"
              className={styles.link}
            >
              120+ first-party publishers
            </Link>{" "}
            are onboarded to the Pyth Network, including some of the biggest
            exchanges and market making firms in the world.{" "}
            <Link
              href="https://defillama.com/oracles/Pyth"
              target="_blank"
              className={styles.link}
            >
              Over 250 protocols
            ...
            <div className={styles.productGrid}>
              <div className={styles.productCard}>
                <div className={styles.productHeader}>
                  <div
                    className={[styles.productBadge, styles.coreBadge].join(
                      " ",
                    )}
                  >
                    Core
                ...
                <p className={styles.productDescription}>
                  Real-time, high-fidelity market data for smart contracts with
                  sub-second latency.
                </p>
              ...
              <div className={styles.productCard}>
                ...
                <p className={styles.productDescription}>
                  High-performance, low-latency price feeds for institutional
                  applications.
                </p>
                <div className={styles.featureList}>
                  <div className={styles.feature}>
              ...
              <div className={styles.productCard}>
                <div className={styles.productHeader}>
                  <div
                    className={[styles.productBadge, styles.mevBadge].join(" ")}
                  >
                    MEV Protection
                  </div>
                ...
                <p className={styles.productDescription}>
                  Eliminate MEV while gaining access to active searchers and
                  liquidators.
                </p>
                <div className={styles.featureList}>
                  <div className={styles.feature}>
              ...
              <div className={styles.productCard}>
                ...
                <p className={styles.productDescription}>
                  Generate secure random numbers on the blockchain for your
                  applications.
                </p>
                <div className={styles.featureList}>
                  <div className={styles.feature}>
            ...
            <div className={styles.resourceGrid}>
              <div className={styles.resourceCard}>
                ...
                <p className={styles.resourceDescription}>
                  Learn about the Pyth governance token and its role in the
                  network.
                </p>
              ...
              <div className={styles.resourceCard}>
                ...
                <p className={styles.resourceDescription}>
                  Understand how staking ensures data quality and network
                  security.
                </p>
                <Link
                  href="/oracle-integrity-staking"
              ...
              <div className={styles.resourceCard}>
                ...
                <p className={styles.resourceDescription}>
                  Track the network&apos;s adoption, growth, and performance
                  metrics.
                </p>
          ...
          <section className={styles.developerResourcesSection}>
            ...
            <ul className={styles.developerList}>
              <li>
                <strong>
                  <Link
                    href="/pyth-core/contract-addresses"
                    className={styles.link}
                  >
                    Contract Addresses
                  </Link>
