...
// frontmatter fails the build. `product` and `type` are required (exactly one
// each); `area` is optional. The filename doubles as the entry's stable anchor
// slug on the hidden /changelog page.
