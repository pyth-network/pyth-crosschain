...
- **Trustless & verifiable** - built on [commit-reveal protocol](./protocol-design).
- **Low-latency** - randomness available within a [few blocks](./chainlist).
- **Easy to use** - get started in < 5 minutes, no registration required.
- **Cost-efficient** - designed for scalable production use [fees](./chainlist).
...
<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
  <IntegrationCard
    href="./generate-random-numbers-evm"
