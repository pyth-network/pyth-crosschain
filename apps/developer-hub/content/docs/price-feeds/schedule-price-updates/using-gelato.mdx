---
title: "How to Schedule Price Updates with Gelato"
description: "Create automated Gelato tasks to update Pyth price feeds on a schedule with time intervals and price deviation thresholds."
icon: "timer"
---
