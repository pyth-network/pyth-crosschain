---
title: "Using Adrastia to Schedule Real-Time Price Updates"
description: "Learn how to use Adrastia's managed service to automatically schedule and push Pyth price updates with reliability and efficiency."
icon: "robot"
---
