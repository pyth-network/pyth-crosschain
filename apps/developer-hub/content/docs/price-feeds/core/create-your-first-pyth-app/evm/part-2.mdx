---
title: Deploy your Pyth App
description: Deploy your Pyth-powered EVM app and interact with it off-chain
slug: /price-feeds/core/create-your-first-pyth-app/evm/part-2
---
...
<Callout type="info" emoji="ℹ️">
  This tutorial is continuation of the [Part 1: Create a
  Contract](./part-1.mdx). If you haven't completed that part yet, please do so
  before continuing.
</Callout>
