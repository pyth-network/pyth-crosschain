...
<Callout type="info">
  ...
  and update the Pyth State / Wormhole State IDs to the [upgraded Sui addresses](/price-feeds/core/contract-addresses/sui#upgraded-contract-addresses).
...
// here: https://docs.pyth.network/price-feeds/core/contract-addresses/sui
...
Consult [Sui Contract Addresses](../../contract-addresses/sui) to find the current package IDs, or the [upgraded Sui addresses](/price-feeds/core/contract-addresses/sui#upgraded-contract-addresses) for the post-July 31, 2026 upgrade.
