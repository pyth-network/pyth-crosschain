---
title: How to Use Real-Time Data in IOTA Contracts
description: Consume Pyth Network prices in IOTA applications
slug: /price-feeds/core/use-real-time-data/pull-integration/iota
---
