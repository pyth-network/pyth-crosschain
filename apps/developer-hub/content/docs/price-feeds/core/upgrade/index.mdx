...
<Accordions type="single">
  <Accordion title="What happens if I do nothing?">
    **Your Hermes calls will start getting rejected at the cutover on July 31, 2026** — `hermes.pyth.network` will require an API key from that point on. To stay live, please follow the steps mentioned [above](#waiting-for-the-automatic-upgrade).
  </Accordion>
