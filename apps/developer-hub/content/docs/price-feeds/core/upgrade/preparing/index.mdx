...
>
  The "Wait for automatic" path does not apply on Sui. This is because Sui restricts how the Pyth package can be upgraded. See the [Sui upgrade guide](/price-feeds/core/upgrade/preparing/sui).
</Callout>
...
>
  This path does not apply on Sui. This is because . Follow the [Sui upgrade guide](/price-feeds/core/upgrade/preparing/sui) instead.
</Callout>
