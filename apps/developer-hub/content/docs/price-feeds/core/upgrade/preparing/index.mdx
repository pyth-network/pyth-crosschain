...
<Accordions type="single">
  ...
  <Accordion title="My code uses the Hermes REST/SSE API directly — what changes for me?">
    ...
    - **Upgrade early (recommended):** switch your base URL to `pyth.dourolabs.app/hermes` and start sending the API key with your requests. The data format is identical; only auth changes. See the [upgrade guide](/price-feeds/core/upgrade/preparing) for the full path.
