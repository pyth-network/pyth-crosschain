...
<Callout type="info" title="Technical Specification">
  For full technical details on the HIP-3 pusher including price sources, feed composition, security model, and limitations, see the <a href="/price-feeds/pro/hip-3-service/technical-specification" target="_blank" rel="noopener noreferrer">Technical Specification</a> page.
</Callout>
