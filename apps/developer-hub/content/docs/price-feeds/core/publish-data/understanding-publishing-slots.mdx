---
title: Understanding Publishing Slots
description: Learn how publishing slots affect inclusion in aggregated Pyth prices
slug: /price-feeds/core/publish-data/understanding-publishing-slots
---

import { Callout } from "fumadocs-ui/components/callout";

When a quoter publishes a price, the `pyth-client` API also forwards the current slot that it observes on Solana and Pythnet. This value is the publishing slot.
