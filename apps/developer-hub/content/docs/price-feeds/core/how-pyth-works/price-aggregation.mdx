...
Price aggregation combines the prices and confidence intervals submitted by individual data providers into a single aggregate price and confidence interval.
