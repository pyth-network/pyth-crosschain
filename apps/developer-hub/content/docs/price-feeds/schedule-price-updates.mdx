---
title: "How To Schedule Price Updates"
description: "Learn how to automate Pyth price feed updates using Adrastia, Gelato, or Price Pusher for reliable on-chain price data."
icon: "clock"
---
