...
The following diagram illustrates the data flow from different components of Pyth Pro, from publishers to Consumers.

![Pyth Pro Architecture](images/Pyth_Pro_Architecture.svg)
