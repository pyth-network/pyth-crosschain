...
The MCP server includes pre-built **skills** — prompt templates that teach AI assistants specific workflows like portfolio tracking, volatility analysis, FX conversion, and more.

<Callout type="info">
  See the full catalog of available skills and example prompts on the [MCP Skills](/price-feeds/pro/mcp-skills) page.
</Callout>
