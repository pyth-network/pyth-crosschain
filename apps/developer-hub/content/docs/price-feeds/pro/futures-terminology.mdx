...
3. **Rollover dates** vary by commodity — check the [Symbols List API](https://pyth.dourolabs.app/v1/symbols) for exact expiration dates
...
- [Symbols List API](https://pyth.dourolabs.app/v1/symbols) — Full list of available futures feeds with expiration dates
