...
| Asset | Ticker Root | Example Symbol |
| ----- | ----------- | -------------- |
| WTI Crude Oil | WTI | `Commodities.WTIJ6/USD` |
| HH Natural Gas | NGD | `Commodities.NGDJ6/USD` |
| LS Gasoil | GO | `Commodities.GOH6/USD` |
| Copper | CC | `Commodities.CCH6/USD` |
| Aluminium | AL | `Commodities.ALH6/USD` |
| Nickel | NL | `Commodities.NLH6/USD` |
| Lead | LE | `Commodities.LEH6/USD` |
| Tin | TI | `Commodities.TIH6/USD` |
| Palladium | PL | `Commodities.PLH6/USD` |
| Platinum | PT | `Commodities.PTJ6/USD` |
| Uranium | UR | `Commodities.URH6/USD` |
| Corn | CO | `Commodities.COH6/USD` |
| Raw Sugar | RS | `Commodities.RSH6/USD` |

### Equity Indices

| Asset | Ticker Root | Example Symbol |
| ----- | ----------- | -------------- |
| US 500 (S&P 500) | US500 | `Equity.US.US500H6/USD` |
| US 100 (Nasdaq 100) | US100 | `Equity.US.US100H6/USD` |
| US 30 (Dow Jones) | US30 | `Equity.US.US30H6/USD` |
...
| Euro FX | FCD | `Equity.US.FCDH6/USD` |
