...
- [Symbology & Reference Data](/price-feeds/pro/symbology-reference) — Field reference for symbol metadata, including `chain_id`, `expiration_pattern`, and `availability_pattern`
