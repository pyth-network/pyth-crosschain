...
Pyth Pro provides a [TypeScript SDK](https://www.npmjs.com/package/@pythnetwork/pyth-lazer-sdk) for fetching signed updates. Request the `solana` format for the binary update, as this format is used by the Cardano Pyth integration.
