...
<Cards>
  ...
  <Card icon={<CalendarBlank size={18} />} title="SEDA">
    **Best for:** Custom oracle feeds, session-aware data, specialized assets
    ...
    - **Session awareness** — knows when markets are open/closed
...
Use a single source's price directly. Exponent scaling is applied automatically.
...
For stable or pegged assets where a fixed value is appropriate. Use sparingly — constant prices do not respond to market conditions.
...
<Callout type="default" title="Dependencies">
