...
<Callout type="warning">
  Skills require the [Pyth MCP server](/price-feeds/pro/mcp#setup) to be configured first. Some skills also require a [Pyth Pro API key](./acquire-api-key).
</Callout>
...
| Skill | Category | Description | API Key Required |
| --- | --- | --- | --- |
