...
<Callout type="info">
  Skills require the [Pyth MCP server](/price-feeds/pro/mcp) to be configured in your AI assistant. Some skills also require a [Pyth Pro access token](./acquire-access-token).
</Callout>
