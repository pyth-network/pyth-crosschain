...
| --- | --- | --- | --- |
| [Price Alerts](#price-alerts) | Market Data | One-time price threshold and percentage change checks | Yes |
...
| [FX Converter](#fx-converter) | Financial | Currency conversion through USD cross rates | Yes |
| [Portfolio Tracker](#portfolio-tracker) | Financial | Portfolio value, allocation, and P&L tracking | Yes |
| [Funding Rate Monitor](#funding-rate-monitor) | Financial | Perpetual futures funding rates and sentiment | Yes |
