...
> **Note:** Each feed has a minimum supported channel (`min_channel`), discoverable via [`/v1/symbols`](https://pyth-lazer-0.dourolabs.app/docs). You must use a channel at or above the feed's `min_channel`.
