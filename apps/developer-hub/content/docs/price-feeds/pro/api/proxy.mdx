...
| Instance | URL                                              |
| -------- | ------------------------------------------------ |
| Proxy 1  | `https://pyth-lazer-proxy-1.dourolabs.app`       |
| Proxy 2  | `https://pyth-lazer-proxy-2.dourolabs.app`       |
| Proxy 3  | `https://pyth-lazer-proxy-3.dourolabs.app`       |

**API Documentation**: [https://pyth-lazer-proxy-1.dourolabs.app/docs/](https://pyth-lazer-proxy-1.dourolabs.app/docs/)
