...
<Callout type="info">
  The `/{channel}/...` endpoints conform to the [TradingView UDF specification](https://www.tradingview.com/rest-api-spec/), allowing you to connect TradingView charting UIs directly to this API.
</Callout>
