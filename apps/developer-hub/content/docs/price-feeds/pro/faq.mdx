...
There is **no hard cap** outside of any appplicable limits described in your subscription agreements and order forms, but for optimal performance we recommend splitting large subscriptions across multiple connections. The number of connections is limited by your specific usage agreement. If you need to subscribe to many feeds, contact support for guidance on high-volume subscriptions. For more on rate limits, see [Rate Limits](/price-feeds/pro/rate-limits).
