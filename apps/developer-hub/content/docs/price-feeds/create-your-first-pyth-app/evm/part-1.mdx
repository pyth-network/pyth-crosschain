---
title: "Create Your First Pyth App - Part 1"
description: "Learn to create a Solidity contract that reads ETH/USD prices from Pyth oracles and uses them to mint NFTs for $1 worth of ETH."
icon: "hammer"
---
