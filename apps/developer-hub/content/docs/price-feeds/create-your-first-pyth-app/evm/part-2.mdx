---
title: "Deploy Your Pyth App - Part 2"
description: "Deploy your Pyth price feed contract to OP Sepolia testnet and interact with it using command line tools and TypeScript."
icon: "rocket"
---
