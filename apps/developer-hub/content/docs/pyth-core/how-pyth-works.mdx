...
description: >-
  Pyth is a protocol enabling market participants to publish on-chain pricing
  info, involving publishers, an oracle program, and consumers, with cross-chain
  transfer to reach various blockchains.
---
# Design Overview
