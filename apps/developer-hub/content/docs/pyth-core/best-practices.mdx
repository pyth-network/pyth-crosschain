---
title: Best Practices for Pyth Price Feeds
description: >-
  Comprehensive guide on best practices for using Pyth price feeds, including
  fixed-point representation, price availability, adversarial selection, latency
  mitigation, confidence intervals, and futures-based asset pricing.
---
# Best Practices
