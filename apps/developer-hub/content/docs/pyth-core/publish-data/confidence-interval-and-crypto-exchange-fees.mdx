...
description: >-
  Guidance on adjusting crypto exchange prices for aggressive fees when
  calculating confidence intervals, with examples of fee adjustments and
  combined exchange book calculations.
---
