---
title: Sponsored Feeds on Solana
description: >-
  This page details sponsored price feeds on Solana mainnet and devnet,
  including update parameters and account addresses for various assets.
---
