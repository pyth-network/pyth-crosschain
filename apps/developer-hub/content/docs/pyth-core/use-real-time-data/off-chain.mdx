---
title: in Off-Chain Applications
description: >-
  This guide explains how to fetch the latest prices and subscribe to real-time
  price updates in off-chain applications. It also references the deprecated
  `price-service-sdk` and recommends using the `hermes-client` for fetching
  prices and updates. For detailed instructions, see the fetch-price-updates
  guide.
---
