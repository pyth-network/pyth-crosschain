...
description: >-
  Seamlessly integrate real-time Pyth Network price feeds into your EVM smart
  contracts with our step-by-step guide, including SDK setup and hands-on code
  examples.
full: false
index: false
---
