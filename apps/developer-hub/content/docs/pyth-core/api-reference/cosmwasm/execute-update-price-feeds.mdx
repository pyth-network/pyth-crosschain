---
title: Update On-Chain Price Feeds Using Pyth Signed Data
description: >-
  Learn how to update on-chain price feeds with Pyth Network’s signed data via
  Hermes API. Manage fees and validate signatures to ensure secure updates.
full: false
index: false
---
