---
title: 'Pyth Core: Query Price Feed API for Crypto Data'
description: >-
  Retrieve real-time crypto prices, confidence intervals, and EMAs from CosmWasm
  feeds. Query hex feed IDs with timestamps for accurate, up-to-date data.
full: false
index: false
---
