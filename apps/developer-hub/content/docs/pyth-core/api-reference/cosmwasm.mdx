---
title: CosmWasm Contract Reference
description: >-
  This document provides a reference for the CosmWasm contract used by the Pyth
  Network, detailing how to submit and retrieve price updates on-chain.
---
