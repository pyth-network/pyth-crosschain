---
title: 'Get Price API: Fetch Latest Price & Confidence Interval'
description: >-
  Instantly access Pyth price feeds—latest prices, confidence intervals, and
  timestamps—by feed ID. Use update_price_feeds for live updates. Explore API
  docs.
full: false
index: false
---
