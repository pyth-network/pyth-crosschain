---
title: Check Price Feed Existence on Aptos - Pyth Core API
description: >-
  Validate Aptos price feeds with the Pyth Core API. Verify feed activity,
  monitor real-time updates, and streamline feed management for reliable
  performance.
full: false
index: false
---
