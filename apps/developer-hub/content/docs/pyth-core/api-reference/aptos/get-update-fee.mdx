---
title: 'Aptos Octa: Check Price Feed Update Fee'
description: >-
  Retrieve Aptos price feed update fees via the Hermes API and use them in your
  update_price_feeds transactions to ensure accurate on-chain data.
full: false
index: false
---
