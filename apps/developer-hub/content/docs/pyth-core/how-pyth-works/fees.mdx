...
title: Fees
description: >-
  The Pyth Network protocol allows optional data fees for on-chain price feed
  updates, with governance determining fee size and use. Protocol fees
  compensate data providers and can be passed to users, who pay transaction fees
  proportional to their usage, with minimal additional costs.
---
# Fees
