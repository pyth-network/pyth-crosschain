---
title: Hermes - Pyth Network Price Service
description: >-
  Hermes is a web service that listens to the Pythnet and Wormhole Network for
  price updates, providing a cost-effective API for recent price data,
  accessible via REST or server-sent events, integral to Pyth's on-chain
  verification.
---
# Hermes
