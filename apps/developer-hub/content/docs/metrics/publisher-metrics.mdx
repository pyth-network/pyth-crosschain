...
description: Pyth Publishers Metrics provides insights that empower developers, publishers, and delegators by providing the historical performance of the network's data sources.
---
