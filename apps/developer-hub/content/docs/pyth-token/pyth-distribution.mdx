...
import PrivateSalesVestingDark from "./images/PYTH_Private_Sales_Vesting_Schedule_Dark.jpg";
import PrivateSalesVestingLight from "./images/PYTH_Private_Sales_Vesting_Schedule_Light.jpg";
