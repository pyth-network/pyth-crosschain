...
pub async fn get_price_feed(
    ...
    verbose: Option<bool>,
    binary: Option<bool>,
) -> Result<models::RpcPriceFeed, Error<GetPriceFeedError>> {
...
pub async fn get_vaa(
    ...
    id: &str,
    publish_time: i64,
) -> Result<models::GetVaaResponse, Error<GetVaaError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_id = id;
    let p_publish_time = publish_time;
...
) -> Result<models::GetVaaCcipResponse, Error<GetVaaCcipError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_data = data;
...
pub async fn latest_price_feeds(
    ...
    verbose: Option<bool>,
    binary: Option<bool>,
) -> Result<Vec<models::RpcPriceFeed>, Error<LatestPriceFeedsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_verbose = verbose;
    let p_binary = binary;
...
pub async fn latest_price_updates(
    configuration: &configuration::Configuration,
    ids: Vec<String>,
    encoding: Option<models::EncodingType>,
    parsed: Option<bool>,
    ignore_invalid_price_ids: Option<bool>,
) -> Result<models::PriceUpdate, Error<LatestPriceUpdatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
...
pub async fn latest_publisher_stake_caps(
    configuration: &configuration::Configuration,
    encoding: Option<models::EncodingType>,
    parsed: Option<bool>,
) -> Result<models::LatestPublisherStakeCapsUpdateDataResponse, Error<LatestPublisherStakeCapsError>>
{
    // add a prefix to parameters to efficiently prevent name collisions
    let p_encoding = encoding;
    let p_parsed = parsed;
...
pub async fn latest_twaps(
    configuration: &configuration::Configuration,
    window_seconds: i64,
    ids_left_square_bracket_right_square_bracket: Vec<String>,
    encoding: Option<models::EncodingType>,
    parsed: Option<bool>,
    ignore_invalid_price_ids: Option<bool>,
) -> Result<models::TwapsResponse, Error<LatestTwapsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_window_seconds = window_seconds;
    let p_ids_left_square_bracket_right_square_bracket =
    ...
    req_builder = match "multi" {
        "multi" => req_builder.query(
            &p_ids_left_square_bracket_right_square_bracket
                .into_iter()
                .map(|p| ("ids[]".to_owned(), p.to_string()))
                .collect::<Vec<(std::string::String, std::string::String)>>(),
        ),
...
pub async fn latest_vaas(
    configuration: &configuration::Configuration,
    ids_left_square_bracket_right_square_bracket: Vec<String>,
) -> Result<Vec<String>, Error<LatestVaasError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids_left_square_bracket_right_square_bracket =
        ids_left_square_bracket_right_square_bracket;
...
pub async fn price_feed_ids(
    configuration: &configuration::Configuration,
) -> Result<Vec<String>, Error<PriceFeedIdsError>> {
...
) -> Result<Vec<models::PriceFeedMetadata>, Error<PriceFeedsMetadataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query = query;
...
pub async fn price_stream_sse_handler(
    ...
    ignore_invalid_price_ids: Option<bool>,
) -> Result<models::PriceUpdate, Error<PriceStreamSseHandlerError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_ids = ids;
    let p_encoding = encoding;
    let p_parsed = parsed;
...
pub async fn timestamp_price_updates(
    ...
    parsed: Option<bool>,
    ignore_invalid_price_ids: Option<bool>,
) -> Result<models::PriceUpdate, Error<TimestampPriceUpdatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_publish_time = publish_time;
    let p_ids = ids;
    let p_encoding = encoding;
